...
#ifndef _SAM9X7_UDPHS_INSTANCE_
#define _SAM9X7_UDPHS_INSTANCE_


/* ========== Instance Parameter definitions for UDPHS peripheral ========== */
#define UDPHS_CLOCK_ID                           (23)       
#define UDPHS_INSTANCE_ID                        (23)       /* USB Device High Speed */

#endif /* _SAM9X7_UDPHS_INSTANCE_ */
