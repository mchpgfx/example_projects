...
#ifndef _SAM9X7_PIT_COMPONENT_H_
#define _SAM9X7_PIT_COMPONENT_H_
...
#define PIT_MR_RESETVALUE                     _UINT32_(0xFFFFF)                                    /*  (PIT_MR) Mode Register  Reset Value */
...
#define   PIT_MR_PITEN_0_Val                  _UINT32_(0x0)                                        /* (PIT_MR) The Periodic Interval Timer is disabled when the PIV value is reached.  */
#define   PIT_MR_PITEN_1_Val                  _UINT32_(0x1)                                        /* (PIT_MR) The Periodic Interval Timer is enabled.  */
#define PIT_MR_PITEN_0                        (PIT_MR_PITEN_0_Val << PIT_MR_PITEN_Pos)             /* (PIT_MR) The Periodic Interval Timer is disabled when the PIV value is reached. Position  */
#define PIT_MR_PITEN_1                        (PIT_MR_PITEN_1_Val << PIT_MR_PITEN_Pos)             /* (PIT_MR) The Periodic Interval Timer is enabled. Position  */
...
#define   PIT_MR_PITIEN_0_Val                 _UINT32_(0x0)                                        /* (PIT_MR) The bit PITS in PIT_SR has no effect on interrupt.  */
#define   PIT_MR_PITIEN_1_Val                 _UINT32_(0x1)                                        /* (PIT_MR) The bit PITS in PIT_SR asserts interrupt.  */
#define PIT_MR_PITIEN_0                       (PIT_MR_PITIEN_0_Val << PIT_MR_PITIEN_Pos)           /* (PIT_MR) The bit PITS in PIT_SR has no effect on interrupt. Position  */
#define PIT_MR_PITIEN_1                       (PIT_MR_PITIEN_1_Val << PIT_MR_PITIEN_Pos)           /* (PIT_MR) The bit PITS in PIT_SR asserts interrupt. Position  */
#define PIT_MR_Msk                            _UINT32_(0x030FFFFF)                                 /* (PIT_MR) Register Mask  */


/* -------- PIT_SR : (PIT Offset: 0x04) ( R/ 32) Status Register -------- */
#define PIT_SR_RESETVALUE                     _UINT32_(0x00)                                       /*  (PIT_SR) Status Register  Reset Value */
...
#define   PIT_SR_PITS_0_Val                   _UINT32_(0x0)                                        /* (PIT_SR) The Periodic Interval timer has not reached PIV since the last read of PIT_PIVR.  */
#define   PIT_SR_PITS_1_Val                   _UINT32_(0x1)                                        /* (PIT_SR) The Periodic Interval timer has reached PIV since the last read of PIT_PIVR.  */
#define PIT_SR_PITS_0                         (PIT_SR_PITS_0_Val << PIT_SR_PITS_Pos)               /* (PIT_SR) The Periodic Interval timer has not reached PIV since the last read of PIT_PIVR. Position  */
#define PIT_SR_PITS_1                         (PIT_SR_PITS_1_Val << PIT_SR_PITS_Pos)               /* (PIT_SR) The Periodic Interval timer has reached PIV since the last read of PIT_PIVR. Position  */
#define PIT_SR_Msk                            _UINT32_(0x00000001)                                 /* (PIT_SR) Register Mask  */


/* -------- PIT_PIVR : (PIT Offset: 0x08) ( R/ 32) Periodic Interval Value Register -------- */
#define PIT_PIVR_RESETVALUE                   _UINT32_(0x00)                                       /*  (PIT_PIVR) Periodic Interval Value Register  Reset Value */
...
#define PIT_PIIR_RESETVALUE                   _UINT32_(0x00)                                       /*  (PIT_PIIR) Periodic Interval Image Register  Reset Value */
...
#endif /* _SAM9X7_PIT_COMPONENT_H_ */
