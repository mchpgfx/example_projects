...
#define PIOC_PSR_DEFAULT_VAL                     (0xFDFFFFFF) /* Register value at reset */
#define PIOC_PUSR_DEFAULT_VAL                    (0x02000000) /* Register value at reset */

#endif /* _SAM9X7_PIOC_INSTANCE_ */
