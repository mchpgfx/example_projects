...
#ifndef _SAM9X7_TDES_COMPONENT_H_
#define _SAM9X7_TDES_COMPONENT_H_
...
#define TDES_MR_RESETVALUE                    _UINT32_(0x00)                                       /*  (TDES_MR) Mode Register  Reset Value */
...
#endif /* _SAM9X7_TDES_COMPONENT_H_ */
