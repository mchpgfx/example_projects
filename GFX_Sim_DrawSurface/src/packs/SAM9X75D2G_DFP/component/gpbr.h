...
#define   GPBR_FCLR_FCLR_0_Val                _UINT32_(0x0)                                        /* (GPBR_FCLR) SYS_GPBR0 to SYS_GPBR3 are immediately cleared in case of fast wake-up pin tamper event.  */
#define   GPBR_FCLR_FCLR_1_Val                _UINT32_(0x1)                                        /* (GPBR_FCLR) All SYS_GPBRx are immediately cleared in case of fast wake-up pin tamper event  */
#define GPBR_FCLR_FCLR_0                      (GPBR_FCLR_FCLR_0_Val << GPBR_FCLR_FCLR_Pos)         /* (GPBR_FCLR) SYS_GPBR0 to SYS_GPBR3 are immediately cleared in case of fast wake-up pin tamper event. Position  */
#define GPBR_FCLR_FCLR_1                      (GPBR_FCLR_FCLR_1_Val << GPBR_FCLR_FCLR_Pos)         /* (GPBR_FCLR) All SYS_GPBRx are immediately cleared in case of fast wake-up pin tamper event Position  */
