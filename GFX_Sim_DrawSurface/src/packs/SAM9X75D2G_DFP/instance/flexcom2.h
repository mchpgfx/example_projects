...
#ifndef _SAM9X7_FLEXCOM2_INSTANCE_
#define _SAM9X7_FLEXCOM2_INSTANCE_


/* ========== Instance Parameter definitions for FLEXCOM2 peripheral ========== */
#define FLEXCOM2_CLOCK_ID                        (7)        
#define FLEXCOM2_DMAC_ID_RX                      (5)        
#define FLEXCOM2_DMAC_ID_TX                      (4)        
#define FLEXCOM2_INSTANCE_ID                     (7)        /* Flexcom 2 */
#define FLEXCOM2_SPI_FIFO_SIZE                   (16)       
#define FLEXCOM2_TWI_FIFO_SIZE                   (16)       
#define FLEXCOM2_USART_FIFO_SIZE                 (16)       

#endif /* _SAM9X7_FLEXCOM2_INSTANCE_ */
