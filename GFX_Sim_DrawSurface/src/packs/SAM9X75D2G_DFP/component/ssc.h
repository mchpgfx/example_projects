...
#ifndef _SAM9X7_SSC_COMPONENT_H_
#define _SAM9X7_SSC_COMPONENT_H_
...
#define SSC_RHR_RESETVALUE                    _UINT32_(0x00)                                       /*  (SSC_RHR) Receive Holding Register  Reset Value */
...
#define   SSC_SR_TXRDY_0_Val                  _UINT32_(0x0)                                        /* (SSC_SR) Data has been loaded in SSC_THR and is waiting to be loaded in the Transmit Shift register (TSR).  */
#define   SSC_SR_TXRDY_1_Val                  _UINT32_(0x1)                                        /* (SSC_SR) SSC_THR is empty.  */
#define SSC_SR_TXRDY_0                        (SSC_SR_TXRDY_0_Val << SSC_SR_TXRDY_Pos)             /* (SSC_SR) Data has been loaded in SSC_THR and is waiting to be loaded in the Transmit Shift register (TSR). Position  */
#define SSC_SR_TXRDY_1                        (SSC_SR_TXRDY_1_Val << SSC_SR_TXRDY_Pos)             /* (SSC_SR) SSC_THR is empty. Position  */
...
#define   SSC_SR_TXEMPTY_0_Val                _UINT32_(0x0)                                        /* (SSC_SR) Data remains in SSC_THR or is currently transmitted from TSR.  */
#define   SSC_SR_TXEMPTY_1_Val                _UINT32_(0x1)                                        /* (SSC_SR) Last data written in SSC_THR has been loaded in TSR and last data loaded in TSR has been transmitted.  */
#define SSC_SR_TXEMPTY_0                      (SSC_SR_TXEMPTY_0_Val << SSC_SR_TXEMPTY_Pos)         /* (SSC_SR) Data remains in SSC_THR or is currently transmitted from TSR. Position  */
#define SSC_SR_TXEMPTY_1                      (SSC_SR_TXEMPTY_1_Val << SSC_SR_TXEMPTY_Pos)         /* (SSC_SR) Last data written in SSC_THR has been loaded in TSR and last data loaded in TSR has been transmitted. Position  */
...
#define   SSC_SR_RXRDY_0_Val                  _UINT32_(0x0)                                        /* (SSC_SR) SSC_RHR is empty.  */
#define   SSC_SR_RXRDY_1_Val                  _UINT32_(0x1)                                        /* (SSC_SR) Data has been received and loaded in SSC_RHR.  */
#define SSC_SR_RXRDY_0                        (SSC_SR_RXRDY_0_Val << SSC_SR_RXRDY_Pos)             /* (SSC_SR) SSC_RHR is empty. Position  */
#define SSC_SR_RXRDY_1                        (SSC_SR_RXRDY_1_Val << SSC_SR_RXRDY_Pos)             /* (SSC_SR) Data has been received and loaded in SSC_RHR. Position  */
...
#define   SSC_SR_OVRUN_0_Val                  _UINT32_(0x0)                                        /* (SSC_SR) No data has been loaded in SSC_RHR while previous data has not been read since the last read of the Status register.  */
#define   SSC_SR_OVRUN_1_Val                  _UINT32_(0x1)                                        /* (SSC_SR) Data has been loaded in SSC_RHR while previous data has not yet been read since the last read of the Status register.  */
#define SSC_SR_OVRUN_0                        (SSC_SR_OVRUN_0_Val << SSC_SR_OVRUN_Pos)             /* (SSC_SR) No data has been loaded in SSC_RHR while previous data has not been read since the last read of the Status register. Position  */
#define SSC_SR_OVRUN_1                        (SSC_SR_OVRUN_1_Val << SSC_SR_OVRUN_Pos)             /* (SSC_SR) Data has been loaded in SSC_RHR while previous data has not yet been read since the last read of the Status register. Position  */
...
#endif /* _SAM9X7_SSC_COMPONENT_H_ */
