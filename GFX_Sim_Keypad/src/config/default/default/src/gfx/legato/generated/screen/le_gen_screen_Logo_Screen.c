...
leResult screenShow_Logo_Screen(void)
{
    ...
    Logo_Screen_LabelWidget_KeyPress->fn->setPosition(Logo_Screen_LabelWidget_KeyPress, 42, 17);
    Logo_Screen_LabelWidget_KeyPress->fn->setSize(Logo_Screen_LabelWidget_KeyPress, 133, 32);
    ...
    Logo_Screen_ButtonWidget_TicTacToe->fn->setPosition(Logo_Screen_ButtonWidget_TicTacToe, 657, 17);
    Logo_Screen_ButtonWidget_TicTacToe->fn->setSize(Logo_Screen_ButtonWidget_TicTacToe, 115, 32);
    ...
    Logo_Screen_TextFieldWidget->fn->setSize(Logo_Screen_TextFieldWidget, 114, 32);
    ...
    Logo_Screen_TextFieldWidget->fn->setHAlignment(Logo_Screen_TextFieldWidget, LE_HALIGN_LEFT);
