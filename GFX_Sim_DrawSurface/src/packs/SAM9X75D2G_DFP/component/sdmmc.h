...
#define SDMMC_PSR_Msk                         _UINT32_(0x01F00F07)                                 /* (SDMMC_PSR) Register Mask  */
...
#define SDMMC_HC1R_SD_SDIO_Msk                _UINT8_(0x5F)                                         /* (SDMMC_HC1R_SD_SDIO) Register Mask  */
...
#define   SDMMC_BGCR_STPBGR_0_Val             _UINT8_(0x0)                                         /* (SDMMC_BGCR) Transfer  */
#define   SDMMC_BGCR_STPBGR_1_Val             _UINT8_(0x1)                                         /* (SDMMC_BGCR) Stop  */
...
#define   SDMMC_BGCR_CONTR_0_Val              _UINT8_(0x0)                                         /* (SDMMC_BGCR) No effect.  */
#define   SDMMC_BGCR_CONTR_1_Val              _UINT8_(0x1)                                         /* (SDMMC_BGCR) Restart.  */
...
#define SDMMC_BGCR_Msk                        _UINT8_(0x03)                                        /* (SDMMC_BGCR) Register Mask  */
...
#define SDMMC_BGCR_SD_SDIO_Msk                _UINT8_(0x0C)                                         /* (SDMMC_BGCR_SD_SDIO) Register Mask  */
...
#define SDMMC_WCR_Msk                         _UINT8_(0x01)                                        /* (SDMMC_WCR) Register Mask  */
...
#define SDMMC_NISTR_SD_SDIO_Msk               _UINT16_(0x813F)                                      /* (SDMMC_NISTR_SD_SDIO) Register Mask  */
...
#define SDMMC_EISTR_EMMC_Msk                  _UINT16_(0x13FF)                                      /* (SDMMC_EISTR_EMMC) Register Mask  */
...
#define SDMMC_NISTER_SD_SDIO_Msk              _UINT16_(0x013F)                                      /* (SDMMC_NISTER_SD_SDIO) Register Mask  */
...
#define SDMMC_EISTER_EMMC_Msk                 _UINT16_(0x13FF)                                      /* (SDMMC_EISTER_EMMC) Register Mask  */
...
#define SDMMC_NISIER_SD_SDIO_Msk              _UINT16_(0x013F)                                      /* (SDMMC_NISIER_SD_SDIO) Register Mask  */
...
#define SDMMC_EISIER_EMMC_Msk                 _UINT16_(0x13FF)                                      /* (SDMMC_EISIER_EMMC) Register Mask  */
...
#define   SDMMC_HC2R_PVALEN_0_Val             _UINT16_(0x0)                                        /* (SDMMC_HC2R) SDCLK and Driver strength are controlled by the user.  */
#define   SDMMC_HC2R_PVALEN_1_Val             _UINT16_(0x1)                                        /* (SDMMC_HC2R) Automatic selection by Preset Value is enabled.  */
...
#define SDMMC_HC2R_Msk                        _UINT16_(0x8000)                                     /* (SDMMC_HC2R) Register Mask  */

/* EMMC mode */
#define SDMMC_HC2R_EMMC_Msk                   _UINT16_(0x0000)                                      /* (SDMMC_HC2R_EMMC) Register Mask  */
...
#define SDMMC_HC2R_SD_SDIO_Msk                _UINT16_(0x4000)                                      /* (SDMMC_HC2R_SD_SDIO) Register Mask  */


/* -------- SDMMC_CA0R : (SDMMC Offset: 0x40) (R/W 32) Capabilities 0 Register -------- */
#define SDMMC_CA0R_RESETVALUE                 _UINT32_(0x27E832B2)                                 /*  (SDMMC_CA0R) Capabilities 0 Register  Reset Value */
...
#define SDMMC_PVR_Msk                         _UINT16_(0x07FF)                                     /* (SDMMC_PVR) Register Mask  */
...
#define SDMMC_HCVR_RESETVALUE                 _UINT16_(0x1802)                                     /*  (SDMMC_HCVR) Host Controller Version Register  Reset Value */
...
#define SDMMC_MC1R_Msk                        _UINT8_(0x3B)                                        /* (SDMMC_MC1R) Register Mask  */
...
{  /* Secure Digital MultiMedia Card Controller */
  ...
  __IO  uint16_t                       SDMMC_PVR[3];       /**< Offset: 0x60 (R/W  16) Preset Value Register x (for initialization) */
...
#endif /* _SAM9X7_SDMMC_COMPONENT_H_ */
