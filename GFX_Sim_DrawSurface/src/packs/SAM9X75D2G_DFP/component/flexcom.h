...
#define   FLEX_MR_OPMODE_USART_Val            _UINT32_(0x1)                                        /* (FLEX_MR) All UART related protocols are selected (RS232, RS485, IrDA, ISO7816, LIN, LON) SPI/TWI related registers are not accessible and have no impact on IOs.  */
...
#define   FLEX_US_MR_USART_MODE_LON_Val       _UINT32_(0x9)                                        /* (FLEX_US_MR) LON  */
...
#define FLEX_US_IER_LIN_Msk                   _UINT32_(0xFE00E1C0)                                  /* (FLEX_US_IER_LIN) Register Mask  */

/* LON mode */
#define FLEX_US_IER_LON_LSFE_Pos              _UINT32_(6)                                          /* (FLEX_US_IER) LON Short Frame Error Interrupt Enable Position */
#define FLEX_US_IER_LON_LSFE_Msk              (_UINT32_(0x1) << FLEX_US_IER_LON_LSFE_Pos)          /* (FLEX_US_IER) LON Short Frame Error Interrupt Enable Mask */
#define FLEX_US_IER_LON_LSFE(value)           (FLEX_US_IER_LON_LSFE_Msk & (_UINT32_(value) << FLEX_US_IER_LON_LSFE_Pos))
#define FLEX_US_IER_LON_LCRCE_Pos             _UINT32_(7)                                          /* (FLEX_US_IER) LON CRC Error Interrupt Enable Position */
#define FLEX_US_IER_LON_LCRCE_Msk             (_UINT32_(0x1) << FLEX_US_IER_LON_LCRCE_Pos)         /* (FLEX_US_IER) LON CRC Error Interrupt Enable Mask */
#define FLEX_US_IER_LON_LCRCE(value)          (FLEX_US_IER_LON_LCRCE_Msk & (_UINT32_(value) << FLEX_US_IER_LON_LCRCE_Pos))
#define FLEX_US_IER_LON_UNRE_Pos              _UINT32_(10)                                         /* (FLEX_US_IER) Underrun Error Interrupt Enable Position */
#define FLEX_US_IER_LON_UNRE_Msk              (_UINT32_(0x1) << FLEX_US_IER_LON_UNRE_Pos)          /* (FLEX_US_IER) Underrun Error Interrupt Enable Mask */
#define FLEX_US_IER_LON_UNRE(value)           (FLEX_US_IER_LON_UNRE_Msk & (_UINT32_(value) << FLEX_US_IER_LON_UNRE_Pos))
#define FLEX_US_IER_LON_LTXD_Pos              _UINT32_(24)                                         /* (FLEX_US_IER) LON Transmission Done Interrupt Enable Position */
#define FLEX_US_IER_LON_LTXD_Msk              (_UINT32_(0x1) << FLEX_US_IER_LON_LTXD_Pos)          /* (FLEX_US_IER) LON Transmission Done Interrupt Enable Mask */
#define FLEX_US_IER_LON_LTXD(value)           (FLEX_US_IER_LON_LTXD_Msk & (_UINT32_(value) << FLEX_US_IER_LON_LTXD_Pos))
#define FLEX_US_IER_LON_LCOL_Pos              _UINT32_(25)                                         /* (FLEX_US_IER) LON Collision Interrupt Enable Position */
#define FLEX_US_IER_LON_LCOL_Msk              (_UINT32_(0x1) << FLEX_US_IER_LON_LCOL_Pos)          /* (FLEX_US_IER) LON Collision Interrupt Enable Mask */
#define FLEX_US_IER_LON_LCOL(value)           (FLEX_US_IER_LON_LCOL_Msk & (_UINT32_(value) << FLEX_US_IER_LON_LCOL_Pos))
#define FLEX_US_IER_LON_LFET_Pos              _UINT32_(26)                                         /* (FLEX_US_IER) LON Frame Early Termination Interrupt Enable Position */
#define FLEX_US_IER_LON_LFET_Msk              (_UINT32_(0x1) << FLEX_US_IER_LON_LFET_Pos)          /* (FLEX_US_IER) LON Frame Early Termination Interrupt Enable Mask */
#define FLEX_US_IER_LON_LFET(value)           (FLEX_US_IER_LON_LFET_Msk & (_UINT32_(value) << FLEX_US_IER_LON_LFET_Pos))
#define FLEX_US_IER_LON_LRXD_Pos              _UINT32_(27)                                         /* (FLEX_US_IER) LON Reception Done Interrupt Enable Position */
#define FLEX_US_IER_LON_LRXD_Msk              (_UINT32_(0x1) << FLEX_US_IER_LON_LRXD_Pos)          /* (FLEX_US_IER) LON Reception Done Interrupt Enable Mask */
#define FLEX_US_IER_LON_LRXD(value)           (FLEX_US_IER_LON_LRXD_Msk & (_UINT32_(value) << FLEX_US_IER_LON_LRXD_Pos))
#define FLEX_US_IER_LON_LBLOVFE_Pos           _UINT32_(28)                                         /* (FLEX_US_IER) LON Backlog Overflow Error Interrupt Enable Position */
#define FLEX_US_IER_LON_LBLOVFE_Msk           (_UINT32_(0x1) << FLEX_US_IER_LON_LBLOVFE_Pos)       /* (FLEX_US_IER) LON Backlog Overflow Error Interrupt Enable Mask */
#define FLEX_US_IER_LON_LBLOVFE(value)        (FLEX_US_IER_LON_LBLOVFE_Msk & (_UINT32_(value) << FLEX_US_IER_LON_LBLOVFE_Pos))
#define FLEX_US_IER_LON_Msk                   _UINT32_(0x1F0004C0)                                  /* (FLEX_US_IER_LON) Register Mask  */
...
#define FLEX_US_IDR_LIN_Msk                   _UINT32_(0xFE00E1C0)                                  /* (FLEX_US_IDR_LIN) Register Mask  */

/* LON mode */
#define FLEX_US_IDR_LON_LSFE_Pos              _UINT32_(6)                                          /* (FLEX_US_IDR) LON Short Frame Error Interrupt Disable Position */
#define FLEX_US_IDR_LON_LSFE_Msk              (_UINT32_(0x1) << FLEX_US_IDR_LON_LSFE_Pos)          /* (FLEX_US_IDR) LON Short Frame Error Interrupt Disable Mask */
#define FLEX_US_IDR_LON_LSFE(value)           (FLEX_US_IDR_LON_LSFE_Msk & (_UINT32_(value) << FLEX_US_IDR_LON_LSFE_Pos))
#define FLEX_US_IDR_LON_LCRCE_Pos             _UINT32_(7)                                          /* (FLEX_US_IDR) LON CRC Error Interrupt Disable Position */
#define FLEX_US_IDR_LON_LCRCE_Msk             (_UINT32_(0x1) << FLEX_US_IDR_LON_LCRCE_Pos)         /* (FLEX_US_IDR) LON CRC Error Interrupt Disable Mask */
#define FLEX_US_IDR_LON_LCRCE(value)          (FLEX_US_IDR_LON_LCRCE_Msk & (_UINT32_(value) << FLEX_US_IDR_LON_LCRCE_Pos))
#define FLEX_US_IDR_LON_UNRE_Pos              _UINT32_(10)                                         /* (FLEX_US_IDR) Underrun Error Interrupt Disable Position */
#define FLEX_US_IDR_LON_UNRE_Msk              (_UINT32_(0x1) << FLEX_US_IDR_LON_UNRE_Pos)          /* (FLEX_US_IDR) Underrun Error Interrupt Disable Mask */
#define FLEX_US_IDR_LON_UNRE(value)           (FLEX_US_IDR_LON_UNRE_Msk & (_UINT32_(value) << FLEX_US_IDR_LON_UNRE_Pos))
#define FLEX_US_IDR_LON_LTXD_Pos              _UINT32_(24)                                         /* (FLEX_US_IDR) LON Transmission Done Interrupt Disable Position */
#define FLEX_US_IDR_LON_LTXD_Msk              (_UINT32_(0x1) << FLEX_US_IDR_LON_LTXD_Pos)          /* (FLEX_US_IDR) LON Transmission Done Interrupt Disable Mask */
#define FLEX_US_IDR_LON_LTXD(value)           (FLEX_US_IDR_LON_LTXD_Msk & (_UINT32_(value) << FLEX_US_IDR_LON_LTXD_Pos))
#define FLEX_US_IDR_LON_LCOL_Pos              _UINT32_(25)                                         /* (FLEX_US_IDR) LON Collision Interrupt Disable Position */
#define FLEX_US_IDR_LON_LCOL_Msk              (_UINT32_(0x1) << FLEX_US_IDR_LON_LCOL_Pos)          /* (FLEX_US_IDR) LON Collision Interrupt Disable Mask */
#define FLEX_US_IDR_LON_LCOL(value)           (FLEX_US_IDR_LON_LCOL_Msk & (_UINT32_(value) << FLEX_US_IDR_LON_LCOL_Pos))
#define FLEX_US_IDR_LON_LFET_Pos              _UINT32_(26)                                         /* (FLEX_US_IDR) LON Frame Early Termination Interrupt Disable Position */
#define FLEX_US_IDR_LON_LFET_Msk              (_UINT32_(0x1) << FLEX_US_IDR_LON_LFET_Pos)          /* (FLEX_US_IDR) LON Frame Early Termination Interrupt Disable Mask */
#define FLEX_US_IDR_LON_LFET(value)           (FLEX_US_IDR_LON_LFET_Msk & (_UINT32_(value) << FLEX_US_IDR_LON_LFET_Pos))
#define FLEX_US_IDR_LON_LRXD_Pos              _UINT32_(27)                                         /* (FLEX_US_IDR) LON Reception Done Interrupt Disable Position */
#define FLEX_US_IDR_LON_LRXD_Msk              (_UINT32_(0x1) << FLEX_US_IDR_LON_LRXD_Pos)          /* (FLEX_US_IDR) LON Reception Done Interrupt Disable Mask */
#define FLEX_US_IDR_LON_LRXD(value)           (FLEX_US_IDR_LON_LRXD_Msk & (_UINT32_(value) << FLEX_US_IDR_LON_LRXD_Pos))
#define FLEX_US_IDR_LON_LBLOVFE_Pos           _UINT32_(28)                                         /* (FLEX_US_IDR) LON Backlog Overflow Error Interrupt Disable Position */
#define FLEX_US_IDR_LON_LBLOVFE_Msk           (_UINT32_(0x1) << FLEX_US_IDR_LON_LBLOVFE_Pos)       /* (FLEX_US_IDR) LON Backlog Overflow Error Interrupt Disable Mask */
#define FLEX_US_IDR_LON_LBLOVFE(value)        (FLEX_US_IDR_LON_LBLOVFE_Msk & (_UINT32_(value) << FLEX_US_IDR_LON_LBLOVFE_Pos))
#define FLEX_US_IDR_LON_Msk                   _UINT32_(0x1F0004C0)                                  /* (FLEX_US_IDR_LON) Register Mask  */
...
#define FLEX_US_IMR_LIN_Msk                   _UINT32_(0xFE00E1C0)                                  /* (FLEX_US_IMR_LIN) Register Mask  */

/* LON mode */
#define FLEX_US_IMR_LON_LSFE_Pos              _UINT32_(6)                                          /* (FLEX_US_IMR) LON Short Frame Error Interrupt Mask Position */
#define FLEX_US_IMR_LON_LSFE_Msk              (_UINT32_(0x1) << FLEX_US_IMR_LON_LSFE_Pos)          /* (FLEX_US_IMR) LON Short Frame Error Interrupt Mask Mask */
#define FLEX_US_IMR_LON_LSFE(value)           (FLEX_US_IMR_LON_LSFE_Msk & (_UINT32_(value) << FLEX_US_IMR_LON_LSFE_Pos))
#define FLEX_US_IMR_LON_LCRCE_Pos             _UINT32_(7)                                          /* (FLEX_US_IMR) LON CRC Error Interrupt Mask Position */
#define FLEX_US_IMR_LON_LCRCE_Msk             (_UINT32_(0x1) << FLEX_US_IMR_LON_LCRCE_Pos)         /* (FLEX_US_IMR) LON CRC Error Interrupt Mask Mask */
#define FLEX_US_IMR_LON_LCRCE(value)          (FLEX_US_IMR_LON_LCRCE_Msk & (_UINT32_(value) << FLEX_US_IMR_LON_LCRCE_Pos))
#define FLEX_US_IMR_LON_UNRE_Pos              _UINT32_(10)                                         /* (FLEX_US_IMR) Underrun Error Interrupt Mask Position */
#define FLEX_US_IMR_LON_UNRE_Msk              (_UINT32_(0x1) << FLEX_US_IMR_LON_UNRE_Pos)          /* (FLEX_US_IMR) Underrun Error Interrupt Mask Mask */
#define FLEX_US_IMR_LON_UNRE(value)           (FLEX_US_IMR_LON_UNRE_Msk & (_UINT32_(value) << FLEX_US_IMR_LON_UNRE_Pos))
#define FLEX_US_IMR_LON_LTXD_Pos              _UINT32_(24)                                         /* (FLEX_US_IMR) LON Transmission Done Interrupt Mask Position */
#define FLEX_US_IMR_LON_LTXD_Msk              (_UINT32_(0x1) << FLEX_US_IMR_LON_LTXD_Pos)          /* (FLEX_US_IMR) LON Transmission Done Interrupt Mask Mask */
#define FLEX_US_IMR_LON_LTXD(value)           (FLEX_US_IMR_LON_LTXD_Msk & (_UINT32_(value) << FLEX_US_IMR_LON_LTXD_Pos))
#define FLEX_US_IMR_LON_LCOL_Pos              _UINT32_(25)                                         /* (FLEX_US_IMR) LON Collision Interrupt Mask Position */
#define FLEX_US_IMR_LON_LCOL_Msk              (_UINT32_(0x1) << FLEX_US_IMR_LON_LCOL_Pos)          /* (FLEX_US_IMR) LON Collision Interrupt Mask Mask */
#define FLEX_US_IMR_LON_LCOL(value)           (FLEX_US_IMR_LON_LCOL_Msk & (_UINT32_(value) << FLEX_US_IMR_LON_LCOL_Pos))
#define FLEX_US_IMR_LON_LFET_Pos              _UINT32_(26)                                         /* (FLEX_US_IMR) LON Frame Early Termination Interrupt Mask Position */
#define FLEX_US_IMR_LON_LFET_Msk              (_UINT32_(0x1) << FLEX_US_IMR_LON_LFET_Pos)          /* (FLEX_US_IMR) LON Frame Early Termination Interrupt Mask Mask */
#define FLEX_US_IMR_LON_LFET(value)           (FLEX_US_IMR_LON_LFET_Msk & (_UINT32_(value) << FLEX_US_IMR_LON_LFET_Pos))
#define FLEX_US_IMR_LON_LRXD_Pos              _UINT32_(27)                                         /* (FLEX_US_IMR) LON Reception Done Interrupt Mask Position */
#define FLEX_US_IMR_LON_LRXD_Msk              (_UINT32_(0x1) << FLEX_US_IMR_LON_LRXD_Pos)          /* (FLEX_US_IMR) LON Reception Done Interrupt Mask Mask */
#define FLEX_US_IMR_LON_LRXD(value)           (FLEX_US_IMR_LON_LRXD_Msk & (_UINT32_(value) << FLEX_US_IMR_LON_LRXD_Pos))
#define FLEX_US_IMR_LON_LBLOVFE_Pos           _UINT32_(28)                                         /* (FLEX_US_IMR) LON Backlog Overflow Error Interrupt Mask Position */
#define FLEX_US_IMR_LON_LBLOVFE_Msk           (_UINT32_(0x1) << FLEX_US_IMR_LON_LBLOVFE_Pos)       /* (FLEX_US_IMR) LON Backlog Overflow Error Interrupt Mask Mask */
#define FLEX_US_IMR_LON_LBLOVFE(value)        (FLEX_US_IMR_LON_LBLOVFE_Msk & (_UINT32_(value) << FLEX_US_IMR_LON_LBLOVFE_Pos))
#define FLEX_US_IMR_LON_Msk                   _UINT32_(0x1F0004C0)                                  /* (FLEX_US_IMR_LON) Register Mask  */
...
#define FLEX_US_CSR_LIN_Msk                   _UINT32_(0xFE80E1C3)                                  /* (FLEX_US_CSR_LIN) Register Mask  */

/* LON mode */
#define FLEX_US_CSR_LON_RXRDY_Pos             _UINT32_(0)                                          /* (FLEX_US_CSR) Receiver Ready (cleared by reading FLEX_US_RHR) Position */
#define FLEX_US_CSR_LON_RXRDY_Msk             (_UINT32_(0x1) << FLEX_US_CSR_LON_RXRDY_Pos)         /* (FLEX_US_CSR) Receiver Ready (cleared by reading FLEX_US_RHR) Mask */
#define FLEX_US_CSR_LON_RXRDY(value)          (FLEX_US_CSR_LON_RXRDY_Msk & (_UINT32_(value) << FLEX_US_CSR_LON_RXRDY_Pos))
#define   FLEX_US_CSR_LON_RXRDY_0_Val         _UINT32_(0x0)                                        /* (FLEX_US_CSR) No complete character has been received since the last read of FLEX_US_RHR or the receiver is disabled. If characters were being received when the receiver was disabled, RXRDY changes to 1 when the receiver is enabled.  */
#define   FLEX_US_CSR_LON_RXRDY_1_Val         _UINT32_(0x1)                                        /* (FLEX_US_CSR) At least one complete character has been received and FLEX_US_RHR has not yet been read.  */
#define FLEX_US_CSR_LON_RXRDY_0               (FLEX_US_CSR_LON_RXRDY_0_Val << FLEX_US_CSR_LON_RXRDY_Pos) /* (FLEX_US_CSR) No complete character has been received since the last read of FLEX_US_RHR or the receiver is disabled. If characters were being received when the receiver was disabled, RXRDY changes to 1 when the receiver is enabled. Position  */
#define FLEX_US_CSR_LON_RXRDY_1               (FLEX_US_CSR_LON_RXRDY_1_Val << FLEX_US_CSR_LON_RXRDY_Pos) /* (FLEX_US_CSR) At least one complete character has been received and FLEX_US_RHR has not yet been read. Position  */
#define FLEX_US_CSR_LON_TXRDY_Pos             _UINT32_(1)                                          /* (FLEX_US_CSR) Transmitter Ready (cleared by writing FLEX_US_THR) Position */
#define FLEX_US_CSR_LON_TXRDY_Msk             (_UINT32_(0x1) << FLEX_US_CSR_LON_TXRDY_Pos)         /* (FLEX_US_CSR) Transmitter Ready (cleared by writing FLEX_US_THR) Mask */
#define FLEX_US_CSR_LON_TXRDY(value)          (FLEX_US_CSR_LON_TXRDY_Msk & (_UINT32_(value) << FLEX_US_CSR_LON_TXRDY_Pos))
#define   FLEX_US_CSR_LON_TXRDY_0_Val         _UINT32_(0x0)                                        /* (FLEX_US_CSR) A character in FLEX_US_THR is waiting to be transferred to the Transmit Shift Register, or the transmitter is disabled. As soon as the transmitter is enabled, TXRDY becomes 1.  */
#define   FLEX_US_CSR_LON_TXRDY_1_Val         _UINT32_(0x1)                                        /* (FLEX_US_CSR) There is no character in FLEX_US_THR.  */
#define FLEX_US_CSR_LON_TXRDY_0               (FLEX_US_CSR_LON_TXRDY_0_Val << FLEX_US_CSR_LON_TXRDY_Pos) /* (FLEX_US_CSR) A character in FLEX_US_THR is waiting to be transferred to the Transmit Shift Register, or the transmitter is disabled. As soon as the transmitter is enabled, TXRDY becomes 1. Position  */
#define FLEX_US_CSR_LON_TXRDY_1               (FLEX_US_CSR_LON_TXRDY_1_Val << FLEX_US_CSR_LON_TXRDY_Pos) /* (FLEX_US_CSR) There is no character in FLEX_US_THR. Position  */
#define FLEX_US_CSR_LON_LSFE_Pos              _UINT32_(6)                                          /* (FLEX_US_CSR) LON Short Frame Error Position */
#define FLEX_US_CSR_LON_LSFE_Msk              (_UINT32_(0x1) << FLEX_US_CSR_LON_LSFE_Pos)          /* (FLEX_US_CSR) LON Short Frame Error Mask */
#define FLEX_US_CSR_LON_LSFE(value)           (FLEX_US_CSR_LON_LSFE_Msk & (_UINT32_(value) << FLEX_US_CSR_LON_LSFE_Pos))
#define   FLEX_US_CSR_LON_LSFE_0_Val          _UINT32_(0x0)                                        /* (FLEX_US_CSR) No short frame received since the last RSTSTA command was issued.  */
#define   FLEX_US_CSR_LON_LSFE_1_Val          _UINT32_(0x1)                                        /* (FLEX_US_CSR) At least one short frame received since the last RSTSTA command was issued.  */
#define FLEX_US_CSR_LON_LSFE_0                (FLEX_US_CSR_LON_LSFE_0_Val << FLEX_US_CSR_LON_LSFE_Pos) /* (FLEX_US_CSR) No short frame received since the last RSTSTA command was issued. Position  */
#define FLEX_US_CSR_LON_LSFE_1                (FLEX_US_CSR_LON_LSFE_1_Val << FLEX_US_CSR_LON_LSFE_Pos) /* (FLEX_US_CSR) At least one short frame received since the last RSTSTA command was issued. Position  */
#define FLEX_US_CSR_LON_LCRCE_Pos             _UINT32_(7)                                          /* (FLEX_US_CSR) LON CRC Error Position */
#define FLEX_US_CSR_LON_LCRCE_Msk             (_UINT32_(0x1) << FLEX_US_CSR_LON_LCRCE_Pos)         /* (FLEX_US_CSR) LON CRC Error Mask */
#define FLEX_US_CSR_LON_LCRCE(value)          (FLEX_US_CSR_LON_LCRCE_Msk & (_UINT32_(value) << FLEX_US_CSR_LON_LCRCE_Pos))
#define   FLEX_US_CSR_LON_LCRCE_0_Val         _UINT32_(0x0)                                        /* (FLEX_US_CSR) No CRC error has been detected since the last RSTSTA command was issued.  */
#define   FLEX_US_CSR_LON_LCRCE_1_Val         _UINT32_(0x1)                                        /* (FLEX_US_CSR) At least one CRC error has been detected since the last RSTSTA command was issued.  */
#define FLEX_US_CSR_LON_LCRCE_0               (FLEX_US_CSR_LON_LCRCE_0_Val << FLEX_US_CSR_LON_LCRCE_Pos) /* (FLEX_US_CSR) No CRC error has been detected since the last RSTSTA command was issued. Position  */
#define FLEX_US_CSR_LON_LCRCE_1               (FLEX_US_CSR_LON_LCRCE_1_Val << FLEX_US_CSR_LON_LCRCE_Pos) /* (FLEX_US_CSR) At least one CRC error has been detected since the last RSTSTA command was issued. Position  */
#define FLEX_US_CSR_LON_UNRE_Pos              _UINT32_(10)                                         /* (FLEX_US_CSR) Underrun Error Position */
#define FLEX_US_CSR_LON_UNRE_Msk              (_UINT32_(0x1) << FLEX_US_CSR_LON_UNRE_Pos)          /* (FLEX_US_CSR) Underrun Error Mask */
#define FLEX_US_CSR_LON_UNRE(value)           (FLEX_US_CSR_LON_UNRE_Msk & (_UINT32_(value) << FLEX_US_CSR_LON_UNRE_Pos))
#define   FLEX_US_CSR_LON_UNRE_0_Val          _UINT32_(0x0)                                        /* (FLEX_US_CSR) No LON underrun error has occurred since the last RSTSTA command was issued.  */
#define   FLEX_US_CSR_LON_UNRE_1_Val          _UINT32_(0x1)                                        /* (FLEX_US_CSR) At least one LON underrun error has occurred since the last RSTSTA command was issued.  */
#define FLEX_US_CSR_LON_UNRE_0                (FLEX_US_CSR_LON_UNRE_0_Val << FLEX_US_CSR_LON_UNRE_Pos) /* (FLEX_US_CSR) No LON underrun error has occurred since the last RSTSTA command was issued. Position  */
#define FLEX_US_CSR_LON_UNRE_1                (FLEX_US_CSR_LON_UNRE_1_Val << FLEX_US_CSR_LON_UNRE_Pos) /* (FLEX_US_CSR) At least one LON underrun error has occurred since the last RSTSTA command was issued. Position  */
#define FLEX_US_CSR_LON_LTXD_Pos              _UINT32_(24)                                         /* (FLEX_US_CSR) LON Transmission End Flag Position */
#define FLEX_US_CSR_LON_LTXD_Msk              (_UINT32_(0x1) << FLEX_US_CSR_LON_LTXD_Pos)          /* (FLEX_US_CSR) LON Transmission End Flag Mask */
#define FLEX_US_CSR_LON_LTXD(value)           (FLEX_US_CSR_LON_LTXD_Msk & (_UINT32_(value) << FLEX_US_CSR_LON_LTXD_Pos))
#define   FLEX_US_CSR_LON_LTXD_0_Val          _UINT32_(0x0)                                        /* (FLEX_US_CSR) Transmission on going or no transmission occurred since the last RSTSTA command was issued.  */
#define   FLEX_US_CSR_LON_LTXD_1_Val          _UINT32_(0x1)                                        /* (FLEX_US_CSR) At least one transmission has been performed since the last RSTSTA command was issued.  */
#define FLEX_US_CSR_LON_LTXD_0                (FLEX_US_CSR_LON_LTXD_0_Val << FLEX_US_CSR_LON_LTXD_Pos) /* (FLEX_US_CSR) Transmission on going or no transmission occurred since the last RSTSTA command was issued. Position  */
#define FLEX_US_CSR_LON_LTXD_1                (FLEX_US_CSR_LON_LTXD_1_Val << FLEX_US_CSR_LON_LTXD_Pos) /* (FLEX_US_CSR) At least one transmission has been performed since the last RSTSTA command was issued. Position  */
#define FLEX_US_CSR_LON_LCOL_Pos              _UINT32_(25)                                         /* (FLEX_US_CSR) LON Collision Detected Flag Position */
#define FLEX_US_CSR_LON_LCOL_Msk              (_UINT32_(0x1) << FLEX_US_CSR_LON_LCOL_Pos)          /* (FLEX_US_CSR) LON Collision Detected Flag Mask */
#define FLEX_US_CSR_LON_LCOL(value)           (FLEX_US_CSR_LON_LCOL_Msk & (_UINT32_(value) << FLEX_US_CSR_LON_LCOL_Pos))
#define   FLEX_US_CSR_LON_LCOL_0_Val          _UINT32_(0x0)                                        /* (FLEX_US_CSR) No collision occurred while transmitting since the last RSTSTA command was issued.  */
#define   FLEX_US_CSR_LON_LCOL_1_Val          _UINT32_(0x1)                                        /* (FLEX_US_CSR) At least one collision occurred while transmitting since the last RSTSTA command was issued.  */
#define FLEX_US_CSR_LON_LCOL_0                (FLEX_US_CSR_LON_LCOL_0_Val << FLEX_US_CSR_LON_LCOL_Pos) /* (FLEX_US_CSR) No collision occurred while transmitting since the last RSTSTA command was issued. Position  */
#define FLEX_US_CSR_LON_LCOL_1                (FLEX_US_CSR_LON_LCOL_1_Val << FLEX_US_CSR_LON_LCOL_Pos) /* (FLEX_US_CSR) At least one collision occurred while transmitting since the last RSTSTA command was issued. Position  */
#define FLEX_US_CSR_LON_LFET_Pos              _UINT32_(26)                                         /* (FLEX_US_CSR) LON Frame Early Termination Position */
#define FLEX_US_CSR_LON_LFET_Msk              (_UINT32_(0x1) << FLEX_US_CSR_LON_LFET_Pos)          /* (FLEX_US_CSR) LON Frame Early Termination Mask */
#define FLEX_US_CSR_LON_LFET(value)           (FLEX_US_CSR_LON_LFET_Msk & (_UINT32_(value) << FLEX_US_CSR_LON_LFET_Pos))
#define   FLEX_US_CSR_LON_LFET_0_Val          _UINT32_(0x0)                                        /* (FLEX_US_CSR) No frame has been terminated early due to collision detection since the last RSTSTA command was issued.  */
#define   FLEX_US_CSR_LON_LFET_1_Val          _UINT32_(0x1)                                        /* (FLEX_US_CSR) At least one transmission has been terminated due to collision detection since the last RSTSTA command was issued. (This stops the DMA until reset with RSTSTA bit).  */
#define FLEX_US_CSR_LON_LFET_0                (FLEX_US_CSR_LON_LFET_0_Val << FLEX_US_CSR_LON_LFET_Pos) /* (FLEX_US_CSR) No frame has been terminated early due to collision detection since the last RSTSTA command was issued. Position  */
#define FLEX_US_CSR_LON_LFET_1                (FLEX_US_CSR_LON_LFET_1_Val << FLEX_US_CSR_LON_LFET_Pos) /* (FLEX_US_CSR) At least one transmission has been terminated due to collision detection since the last RSTSTA command was issued. (This stops the DMA until reset with RSTSTA bit). Position  */
#define FLEX_US_CSR_LON_LRXD_Pos              _UINT32_(27)                                         /* (FLEX_US_CSR) LON Reception End Flag Position */
#define FLEX_US_CSR_LON_LRXD_Msk              (_UINT32_(0x1) << FLEX_US_CSR_LON_LRXD_Pos)          /* (FLEX_US_CSR) LON Reception End Flag Mask */
#define FLEX_US_CSR_LON_LRXD(value)           (FLEX_US_CSR_LON_LRXD_Msk & (_UINT32_(value) << FLEX_US_CSR_LON_LRXD_Pos))
#define   FLEX_US_CSR_LON_LRXD_0_Val          _UINT32_(0x0)                                        /* (FLEX_US_CSR) Reception on going or no reception occurred since the last RSTSTA command was issued.  */
#define   FLEX_US_CSR_LON_LRXD_1_Val          _UINT32_(0x1)                                        /* (FLEX_US_CSR) At least one reception has been performed since the last RSTSTA command was issued.  */
#define FLEX_US_CSR_LON_LRXD_0                (FLEX_US_CSR_LON_LRXD_0_Val << FLEX_US_CSR_LON_LRXD_Pos) /* (FLEX_US_CSR) Reception on going or no reception occurred since the last RSTSTA command was issued. Position  */
#define FLEX_US_CSR_LON_LRXD_1                (FLEX_US_CSR_LON_LRXD_1_Val << FLEX_US_CSR_LON_LRXD_Pos) /* (FLEX_US_CSR) At least one reception has been performed since the last RSTSTA command was issued. Position  */
#define FLEX_US_CSR_LON_LBLOVFE_Pos           _UINT32_(28)                                         /* (FLEX_US_CSR) LON Backlog Overflow Error Position */
#define FLEX_US_CSR_LON_LBLOVFE_Msk           (_UINT32_(0x1) << FLEX_US_CSR_LON_LBLOVFE_Pos)       /* (FLEX_US_CSR) LON Backlog Overflow Error Mask */
#define FLEX_US_CSR_LON_LBLOVFE(value)        (FLEX_US_CSR_LON_LBLOVFE_Msk & (_UINT32_(value) << FLEX_US_CSR_LON_LBLOVFE_Pos))
#define   FLEX_US_CSR_LON_LBLOVFE_0_Val       _UINT32_(0x0)                                        /* (FLEX_US_CSR) No backlog overflow error occurred since the last RSTSTA command was issued.  */
#define   FLEX_US_CSR_LON_LBLOVFE_1_Val       _UINT32_(0x1)                                        /* (FLEX_US_CSR) At least one backlog error overflow occurred since the last RSTSTA command was issued.  */
#define FLEX_US_CSR_LON_LBLOVFE_0             (FLEX_US_CSR_LON_LBLOVFE_0_Val << FLEX_US_CSR_LON_LBLOVFE_Pos) /* (FLEX_US_CSR) No backlog overflow error occurred since the last RSTSTA command was issued. Position  */
#define FLEX_US_CSR_LON_LBLOVFE_1             (FLEX_US_CSR_LON_LBLOVFE_1_Val << FLEX_US_CSR_LON_LBLOVFE_Pos) /* (FLEX_US_CSR) At least one backlog error overflow occurred since the last RSTSTA command was issued. Position  */
#define FLEX_US_CSR_LON_Msk                   _UINT32_(0x1F0004C3)                                  /* (FLEX_US_CSR_LON) Register Mask  */
...
/* LON mode */
#define FLEX_US_TTGR_LON_PCYCLE_Pos           _UINT32_(0)                                          /* (FLEX_US_TTGR) LON PCYCLE Length Position */
#define FLEX_US_TTGR_LON_PCYCLE_Msk           (_UINT32_(0xFFFFFF) << FLEX_US_TTGR_LON_PCYCLE_Pos)  /* (FLEX_US_TTGR) LON PCYCLE Length Mask */
#define FLEX_US_TTGR_LON_PCYCLE(value)        (FLEX_US_TTGR_LON_PCYCLE_Msk & (_UINT32_(value) << FLEX_US_TTGR_LON_PCYCLE_Pos))
#define FLEX_US_TTGR_LON_Msk                  _UINT32_(0x00FFFFFF)                                  /* (FLEX_US_TTGR_LON) Register Mask  */
...
/* LON mode */
#define FLEX_US_FIDI_LON_BETA2_Pos            _UINT32_(0)                                          /* (FLEX_US_FIDI) LON BETA2 Length Position */
#define FLEX_US_FIDI_LON_BETA2_Msk            (_UINT32_(0xFFFFFF) << FLEX_US_FIDI_LON_BETA2_Pos)   /* (FLEX_US_FIDI) LON BETA2 Length Mask */
#define FLEX_US_FIDI_LON_BETA2(value)         (FLEX_US_FIDI_LON_BETA2_Msk & (_UINT32_(value) << FLEX_US_FIDI_LON_BETA2_Pos))
#define FLEX_US_FIDI_LON_Msk                  _UINT32_(0x00FFFFFF)                                  /* (FLEX_US_FIDI_LON) Register Mask  */
...
#define FLEX_US_LINMR_PDCM_Pos                _UINT32_(16)                                         /* (FLEX_US_LINMR) DMA Mode Position */
#define FLEX_US_LINMR_PDCM_Msk                (_UINT32_(0x1) << FLEX_US_LINMR_PDCM_Pos)            /* (FLEX_US_LINMR) DMA Mode Mask */
...
#define   FLEX_US_LINMR_PDCM_0_Val            _UINT32_(0x0)                                        /* (FLEX_US_LINMR) The LIN mode register FLEX_US_LINMR is not written by the DMA.  */
#define   FLEX_US_LINMR_PDCM_1_Val            _UINT32_(0x1)                                        /* (FLEX_US_LINMR) The LIN mode register FLEX_US_LINMR (excepting that flag) is written by the DMA.  */
#define FLEX_US_LINMR_PDCM_0                  (FLEX_US_LINMR_PDCM_0_Val << FLEX_US_LINMR_PDCM_Pos) /* (FLEX_US_LINMR) The LIN mode register FLEX_US_LINMR is not written by the DMA. Position  */
#define FLEX_US_LINMR_PDCM_1                  (FLEX_US_LINMR_PDCM_1_Val << FLEX_US_LINMR_PDCM_Pos) /* (FLEX_US_LINMR) The LIN mode register FLEX_US_LINMR (excepting that flag) is written by the DMA. Position  */
...
#define FLEX_US_LONMR_RESETVALUE              _UINT32_(0x00)                                       /*  (FLEX_US_LONMR) USART LON Mode Register  Reset Value */

#define FLEX_US_LONMR_COMMT_Pos               _UINT32_(0)                                          /* (FLEX_US_LONMR) LON comm_type Parameter Value Position */
#define FLEX_US_LONMR_COMMT_Msk               (_UINT32_(0x1) << FLEX_US_LONMR_COMMT_Pos)           /* (FLEX_US_LONMR) LON comm_type Parameter Value Mask */
#define FLEX_US_LONMR_COMMT(value)            (FLEX_US_LONMR_COMMT_Msk & (_UINT32_(value) << FLEX_US_LONMR_COMMT_Pos)) /* Assigment of value for COMMT in the FLEX_US_LONMR register */
#define   FLEX_US_LONMR_COMMT_0_Val           _UINT32_(0x0)                                        /* (FLEX_US_LONMR) LON comm_type = 1 mode.  */
#define   FLEX_US_LONMR_COMMT_1_Val           _UINT32_(0x1)                                        /* (FLEX_US_LONMR) LON comm_type = 2 mode.  */
#define FLEX_US_LONMR_COMMT_0                 (FLEX_US_LONMR_COMMT_0_Val << FLEX_US_LONMR_COMMT_Pos) /* (FLEX_US_LONMR) LON comm_type = 1 mode. Position  */
#define FLEX_US_LONMR_COMMT_1                 (FLEX_US_LONMR_COMMT_1_Val << FLEX_US_LONMR_COMMT_Pos) /* (FLEX_US_LONMR) LON comm_type = 2 mode. Position  */
#define FLEX_US_LONMR_COLDET_Pos              _UINT32_(1)                                          /* (FLEX_US_LONMR) LON Collision Detection Feature Position */
#define FLEX_US_LONMR_COLDET_Msk              (_UINT32_(0x1) << FLEX_US_LONMR_COLDET_Pos)          /* (FLEX_US_LONMR) LON Collision Detection Feature Mask */
#define FLEX_US_LONMR_COLDET(value)           (FLEX_US_LONMR_COLDET_Msk & (_UINT32_(value) << FLEX_US_LONMR_COLDET_Pos)) /* Assigment of value for COLDET in the FLEX_US_LONMR register */
#define   FLEX_US_LONMR_COLDET_0_Val          _UINT32_(0x0)                                        /* (FLEX_US_LONMR) LON collision detection feature disabled.  */
#define   FLEX_US_LONMR_COLDET_1_Val          _UINT32_(0x1)                                        /* (FLEX_US_LONMR) LON collision detection feature enabled.  */
#define FLEX_US_LONMR_COLDET_0                (FLEX_US_LONMR_COLDET_0_Val << FLEX_US_LONMR_COLDET_Pos) /* (FLEX_US_LONMR) LON collision detection feature disabled. Position  */
#define FLEX_US_LONMR_COLDET_1                (FLEX_US_LONMR_COLDET_1_Val << FLEX_US_LONMR_COLDET_Pos) /* (FLEX_US_LONMR) LON collision detection feature enabled. Position  */
#define FLEX_US_LONMR_TCOL_Pos                _UINT32_(2)                                          /* (FLEX_US_LONMR) Terminate Frame upon Collision Notification Position */
#define FLEX_US_LONMR_TCOL_Msk                (_UINT32_(0x1) << FLEX_US_LONMR_TCOL_Pos)            /* (FLEX_US_LONMR) Terminate Frame upon Collision Notification Mask */
#define FLEX_US_LONMR_TCOL(value)             (FLEX_US_LONMR_TCOL_Msk & (_UINT32_(value) << FLEX_US_LONMR_TCOL_Pos)) /* Assigment of value for TCOL in the FLEX_US_LONMR register */
#define   FLEX_US_LONMR_TCOL_0_Val            _UINT32_(0x0)                                        /* (FLEX_US_LONMR) Do not terminate the frame in LON comm_type = 1 mode upon collision detection.  */
#define   FLEX_US_LONMR_TCOL_1_Val            _UINT32_(0x1)                                        /* (FLEX_US_LONMR) Terminate the frame in LON comm_type = 1 mode upon collision detection if possible.  */
#define FLEX_US_LONMR_TCOL_0                  (FLEX_US_LONMR_TCOL_0_Val << FLEX_US_LONMR_TCOL_Pos) /* (FLEX_US_LONMR) Do not terminate the frame in LON comm_type = 1 mode upon collision detection. Position  */
#define FLEX_US_LONMR_TCOL_1                  (FLEX_US_LONMR_TCOL_1_Val << FLEX_US_LONMR_TCOL_Pos) /* (FLEX_US_LONMR) Terminate the frame in LON comm_type = 1 mode upon collision detection if possible. Position  */
#define FLEX_US_LONMR_CDTAIL_Pos              _UINT32_(3)                                          /* (FLEX_US_LONMR) LON Collision Detection on Frame Tail Position */
#define FLEX_US_LONMR_CDTAIL_Msk              (_UINT32_(0x1) << FLEX_US_LONMR_CDTAIL_Pos)          /* (FLEX_US_LONMR) LON Collision Detection on Frame Tail Mask */
#define FLEX_US_LONMR_CDTAIL(value)           (FLEX_US_LONMR_CDTAIL_Msk & (_UINT32_(value) << FLEX_US_LONMR_CDTAIL_Pos)) /* Assigment of value for CDTAIL in the FLEX_US_LONMR register */
#define   FLEX_US_LONMR_CDTAIL_0_Val          _UINT32_(0x0)                                        /* (FLEX_US_LONMR) Detect collisions after CRC has been sent but prior end of transmission in LON comm_type = 1 mode.  */
#define   FLEX_US_LONMR_CDTAIL_1_Val          _UINT32_(0x1)                                        /* (FLEX_US_LONMR) Ignore collisions after CRC has been sent but prior end of transmission in LON comm_type = 1 mode.  */
#define FLEX_US_LONMR_CDTAIL_0                (FLEX_US_LONMR_CDTAIL_0_Val << FLEX_US_LONMR_CDTAIL_Pos) /* (FLEX_US_LONMR) Detect collisions after CRC has been sent but prior end of transmission in LON comm_type = 1 mode. Position  */
#define FLEX_US_LONMR_CDTAIL_1                (FLEX_US_LONMR_CDTAIL_1_Val << FLEX_US_LONMR_CDTAIL_Pos) /* (FLEX_US_LONMR) Ignore collisions after CRC has been sent but prior end of transmission in LON comm_type = 1 mode. Position  */
#define FLEX_US_LONMR_DMAM_Pos                _UINT32_(4)                                          /* (FLEX_US_LONMR) LON DMA Mode Position */
#define FLEX_US_LONMR_DMAM_Msk                (_UINT32_(0x1) << FLEX_US_LONMR_DMAM_Pos)            /* (FLEX_US_LONMR) LON DMA Mode Mask */
#define FLEX_US_LONMR_DMAM(value)             (FLEX_US_LONMR_DMAM_Msk & (_UINT32_(value) << FLEX_US_LONMR_DMAM_Pos)) /* Assigment of value for DMAM in the FLEX_US_LONMR register */
#define   FLEX_US_LONMR_DMAM_0_Val            _UINT32_(0x0)                                        /* (FLEX_US_LONMR) The LON data length register FLEX_US_LONDL is not written by the DMA.  */
#define   FLEX_US_LONMR_DMAM_1_Val            _UINT32_(0x1)                                        /* (FLEX_US_LONMR) The LON data length register FLEX_US_LONDL is written by the DMA.  */
#define FLEX_US_LONMR_DMAM_0                  (FLEX_US_LONMR_DMAM_0_Val << FLEX_US_LONMR_DMAM_Pos) /* (FLEX_US_LONMR) The LON data length register FLEX_US_LONDL is not written by the DMA. Position  */
#define FLEX_US_LONMR_DMAM_1                  (FLEX_US_LONMR_DMAM_1_Val << FLEX_US_LONMR_DMAM_Pos) /* (FLEX_US_LONMR) The LON data length register FLEX_US_LONDL is written by the DMA. Position  */
#define FLEX_US_LONMR_LCDS_Pos                _UINT32_(5)                                          /* (FLEX_US_LONMR) LON Collision Detection Source Position */
#define FLEX_US_LONMR_LCDS_Msk                (_UINT32_(0x1) << FLEX_US_LONMR_LCDS_Pos)            /* (FLEX_US_LONMR) LON Collision Detection Source Mask */
#define FLEX_US_LONMR_LCDS(value)             (FLEX_US_LONMR_LCDS_Msk & (_UINT32_(value) << FLEX_US_LONMR_LCDS_Pos)) /* Assigment of value for LCDS in the FLEX_US_LONMR register */
#define   FLEX_US_LONMR_LCDS_0_Val            _UINT32_(0x0)                                        /* (FLEX_US_LONMR) LON collision detection source is external.  */
#define   FLEX_US_LONMR_LCDS_1_Val            _UINT32_(0x1)                                        /* (FLEX_US_LONMR) LON collision detection source is internal.  */
#define FLEX_US_LONMR_LCDS_0                  (FLEX_US_LONMR_LCDS_0_Val << FLEX_US_LONMR_LCDS_Pos) /* (FLEX_US_LONMR) LON collision detection source is external. Position  */
#define FLEX_US_LONMR_LCDS_1                  (FLEX_US_LONMR_LCDS_1_Val << FLEX_US_LONMR_LCDS_Pos) /* (FLEX_US_LONMR) LON collision detection source is internal. Position  */
#define FLEX_US_LONMR_EOFS_Pos                _UINT32_(16)                                         /* (FLEX_US_LONMR) End of Frame Condition Size Position */
#define FLEX_US_LONMR_EOFS_Msk                (_UINT32_(0xFF) << FLEX_US_LONMR_EOFS_Pos)           /* (FLEX_US_LONMR) End of Frame Condition Size Mask */
#define FLEX_US_LONMR_EOFS(value)             (FLEX_US_LONMR_EOFS_Msk & (_UINT32_(value) << FLEX_US_LONMR_EOFS_Pos)) /* Assigment of value for EOFS in the FLEX_US_LONMR register */
#define FLEX_US_LONMR_Msk                     _UINT32_(0x00FF003F)                                 /* (FLEX_US_LONMR) Register Mask  */


/* -------- FLEX_US_LONPR : (FLEXCOM Offset: 0x264) (R/W 32) USART LON Preamble Register -------- */
#define FLEX_US_LONPR_RESETVALUE              _UINT32_(0x00)                                       /*  (FLEX_US_LONPR) USART LON Preamble Register  Reset Value */

#define FLEX_US_LONPR_LONPL_Pos               _UINT32_(0)                                          /* (FLEX_US_LONPR) LON Preamble Length Position */
#define FLEX_US_LONPR_LONPL_Msk               (_UINT32_(0x3FFF) << FLEX_US_LONPR_LONPL_Pos)        /* (FLEX_US_LONPR) LON Preamble Length Mask */
#define FLEX_US_LONPR_LONPL(value)            (FLEX_US_LONPR_LONPL_Msk & (_UINT32_(value) << FLEX_US_LONPR_LONPL_Pos)) /* Assigment of value for LONPL in the FLEX_US_LONPR register */
#define FLEX_US_LONPR_Msk                     _UINT32_(0x00003FFF)                                 /* (FLEX_US_LONPR) Register Mask  */


/* -------- FLEX_US_LONDL : (FLEXCOM Offset: 0x268) (R/W 32) USART LON Data Length Register -------- */
#define FLEX_US_LONDL_RESETVALUE              _UINT32_(0x00)                                       /*  (FLEX_US_LONDL) USART LON Data Length Register  Reset Value */

#define FLEX_US_LONDL_LONDL_Pos               _UINT32_(0)                                          /* (FLEX_US_LONDL) LON Data Length Position */
#define FLEX_US_LONDL_LONDL_Msk               (_UINT32_(0xFF) << FLEX_US_LONDL_LONDL_Pos)          /* (FLEX_US_LONDL) LON Data Length Mask */
#define FLEX_US_LONDL_LONDL(value)            (FLEX_US_LONDL_LONDL_Msk & (_UINT32_(value) << FLEX_US_LONDL_LONDL_Pos)) /* Assigment of value for LONDL in the FLEX_US_LONDL register */
#define FLEX_US_LONDL_Msk                     _UINT32_(0x000000FF)                                 /* (FLEX_US_LONDL) Register Mask  */


/* -------- FLEX_US_LONL2HDR : (FLEXCOM Offset: 0x26C) (R/W 32) USART LON L2HDR Register -------- */
#define FLEX_US_LONL2HDR_RESETVALUE           _UINT32_(0x00)                                       /*  (FLEX_US_LONL2HDR) USART LON L2HDR Register  Reset Value */

#define FLEX_US_LONL2HDR_BLI_Pos              _UINT32_(0)                                          /* (FLEX_US_LONL2HDR) LON Backlog Increment Position */
#define FLEX_US_LONL2HDR_BLI_Msk              (_UINT32_(0x3F) << FLEX_US_LONL2HDR_BLI_Pos)         /* (FLEX_US_LONL2HDR) LON Backlog Increment Mask */
#define FLEX_US_LONL2HDR_BLI(value)           (FLEX_US_LONL2HDR_BLI_Msk & (_UINT32_(value) << FLEX_US_LONL2HDR_BLI_Pos)) /* Assigment of value for BLI in the FLEX_US_LONL2HDR register */
#define FLEX_US_LONL2HDR_ALTP_Pos             _UINT32_(6)                                          /* (FLEX_US_LONL2HDR) LON Alternate Path Bit Position */
#define FLEX_US_LONL2HDR_ALTP_Msk             (_UINT32_(0x1) << FLEX_US_LONL2HDR_ALTP_Pos)         /* (FLEX_US_LONL2HDR) LON Alternate Path Bit Mask */
#define FLEX_US_LONL2HDR_ALTP(value)          (FLEX_US_LONL2HDR_ALTP_Msk & (_UINT32_(value) << FLEX_US_LONL2HDR_ALTP_Pos)) /* Assigment of value for ALTP in the FLEX_US_LONL2HDR register */
#define   FLEX_US_LONL2HDR_ALTP_0_Val         _UINT32_(0x0)                                        /* (FLEX_US_LONL2HDR) LON alternate path bit reset.  */
#define   FLEX_US_LONL2HDR_ALTP_1_Val         _UINT32_(0x1)                                        /* (FLEX_US_LONL2HDR) LON alternate path bit set.  */
#define FLEX_US_LONL2HDR_ALTP_0               (FLEX_US_LONL2HDR_ALTP_0_Val << FLEX_US_LONL2HDR_ALTP_Pos) /* (FLEX_US_LONL2HDR) LON alternate path bit reset. Position  */
#define FLEX_US_LONL2HDR_ALTP_1               (FLEX_US_LONL2HDR_ALTP_1_Val << FLEX_US_LONL2HDR_ALTP_Pos) /* (FLEX_US_LONL2HDR) LON alternate path bit set. Position  */
#define FLEX_US_LONL2HDR_PB_Pos               _UINT32_(7)                                          /* (FLEX_US_LONL2HDR) LON Priority Bit Position */
#define FLEX_US_LONL2HDR_PB_Msk               (_UINT32_(0x1) << FLEX_US_LONL2HDR_PB_Pos)           /* (FLEX_US_LONL2HDR) LON Priority Bit Mask */
#define FLEX_US_LONL2HDR_PB(value)            (FLEX_US_LONL2HDR_PB_Msk & (_UINT32_(value) << FLEX_US_LONL2HDR_PB_Pos)) /* Assigment of value for PB in the FLEX_US_LONL2HDR register */
#define   FLEX_US_LONL2HDR_PB_0_Val           _UINT32_(0x0)                                        /* (FLEX_US_LONL2HDR) LON priority bit reset.  */
#define   FLEX_US_LONL2HDR_PB_1_Val           _UINT32_(0x1)                                        /* (FLEX_US_LONL2HDR) LON priority bit set.  */
#define FLEX_US_LONL2HDR_PB_0                 (FLEX_US_LONL2HDR_PB_0_Val << FLEX_US_LONL2HDR_PB_Pos) /* (FLEX_US_LONL2HDR) LON priority bit reset. Position  */
#define FLEX_US_LONL2HDR_PB_1                 (FLEX_US_LONL2HDR_PB_1_Val << FLEX_US_LONL2HDR_PB_Pos) /* (FLEX_US_LONL2HDR) LON priority bit set. Position  */
#define FLEX_US_LONL2HDR_Msk                  _UINT32_(0x000000FF)                                 /* (FLEX_US_LONL2HDR) Register Mask  */


/* -------- FLEX_US_LONBL : (FLEXCOM Offset: 0x270) ( R/ 32) USART LON Backlog Register -------- */
#define FLEX_US_LONBL_RESETVALUE              _UINT32_(0x00)                                       /*  (FLEX_US_LONBL) USART LON Backlog Register  Reset Value */

#define FLEX_US_LONBL_LONBL_Pos               _UINT32_(0)                                          /* (FLEX_US_LONBL) LON Node Backlog Value Position */
#define FLEX_US_LONBL_LONBL_Msk               (_UINT32_(0x3F) << FLEX_US_LONBL_LONBL_Pos)          /* (FLEX_US_LONBL) LON Node Backlog Value Mask */
#define FLEX_US_LONBL_LONBL(value)            (FLEX_US_LONBL_LONBL_Msk & (_UINT32_(value) << FLEX_US_LONBL_LONBL_Pos)) /* Assigment of value for LONBL in the FLEX_US_LONBL register */
#define FLEX_US_LONBL_Msk                     _UINT32_(0x0000003F)                                 /* (FLEX_US_LONBL) Register Mask  */


/* -------- FLEX_US_LONB1TX : (FLEXCOM Offset: 0x274) (R/W 32) USART LON Beta1 Tx Register -------- */
#define FLEX_US_LONB1TX_RESETVALUE            _UINT32_(0x00)                                       /*  (FLEX_US_LONB1TX) USART LON Beta1 Tx Register  Reset Value */

#define FLEX_US_LONB1TX_BETA1TX_Pos           _UINT32_(0)                                          /* (FLEX_US_LONB1TX) LON Beta1 Length after Transmission Position */
#define FLEX_US_LONB1TX_BETA1TX_Msk           (_UINT32_(0xFFFFFF) << FLEX_US_LONB1TX_BETA1TX_Pos)  /* (FLEX_US_LONB1TX) LON Beta1 Length after Transmission Mask */
#define FLEX_US_LONB1TX_BETA1TX(value)        (FLEX_US_LONB1TX_BETA1TX_Msk & (_UINT32_(value) << FLEX_US_LONB1TX_BETA1TX_Pos)) /* Assigment of value for BETA1TX in the FLEX_US_LONB1TX register */
#define FLEX_US_LONB1TX_Msk                   _UINT32_(0x00FFFFFF)                                 /* (FLEX_US_LONB1TX) Register Mask  */


/* -------- FLEX_US_LONB1RX : (FLEXCOM Offset: 0x278) (R/W 32) USART LON Beta1 Rx Register -------- */
#define FLEX_US_LONB1RX_RESETVALUE            _UINT32_(0x00)                                       /*  (FLEX_US_LONB1RX) USART LON Beta1 Rx Register  Reset Value */

#define FLEX_US_LONB1RX_BETA1RX_Pos           _UINT32_(0)                                          /* (FLEX_US_LONB1RX) LON Beta1 Length after Reception Position */
#define FLEX_US_LONB1RX_BETA1RX_Msk           (_UINT32_(0xFFFFFF) << FLEX_US_LONB1RX_BETA1RX_Pos)  /* (FLEX_US_LONB1RX) LON Beta1 Length after Reception Mask */
#define FLEX_US_LONB1RX_BETA1RX(value)        (FLEX_US_LONB1RX_BETA1RX_Msk & (_UINT32_(value) << FLEX_US_LONB1RX_BETA1RX_Pos)) /* Assigment of value for BETA1RX in the FLEX_US_LONB1RX register */
#define FLEX_US_LONB1RX_Msk                   _UINT32_(0x00FFFFFF)                                 /* (FLEX_US_LONB1RX) Register Mask  */


/* -------- FLEX_US_LONPRIO : (FLEXCOM Offset: 0x27C) (R/W 32) USART LON Priority Register -------- */
#define FLEX_US_LONPRIO_RESETVALUE            _UINT32_(0x00)                                       /*  (FLEX_US_LONPRIO) USART LON Priority Register  Reset Value */

#define FLEX_US_LONPRIO_PSNB_Pos              _UINT32_(0)                                          /* (FLEX_US_LONPRIO) LON Priority Slot Number Position */
#define FLEX_US_LONPRIO_PSNB_Msk              (_UINT32_(0x7F) << FLEX_US_LONPRIO_PSNB_Pos)         /* (FLEX_US_LONPRIO) LON Priority Slot Number Mask */
#define FLEX_US_LONPRIO_PSNB(value)           (FLEX_US_LONPRIO_PSNB_Msk & (_UINT32_(value) << FLEX_US_LONPRIO_PSNB_Pos)) /* Assigment of value for PSNB in the FLEX_US_LONPRIO register */
#define FLEX_US_LONPRIO_NPS_Pos               _UINT32_(8)                                          /* (FLEX_US_LONPRIO) LON Node Priority Slot Position */
#define FLEX_US_LONPRIO_NPS_Msk               (_UINT32_(0x7F) << FLEX_US_LONPRIO_NPS_Pos)          /* (FLEX_US_LONPRIO) LON Node Priority Slot Mask */
#define FLEX_US_LONPRIO_NPS(value)            (FLEX_US_LONPRIO_NPS_Msk & (_UINT32_(value) << FLEX_US_LONPRIO_NPS_Pos)) /* Assigment of value for NPS in the FLEX_US_LONPRIO register */
#define FLEX_US_LONPRIO_Msk                   _UINT32_(0x00007F7F)                                 /* (FLEX_US_LONPRIO) Register Mask  */


/* -------- FLEX_US_IDTTX : (FLEXCOM Offset: 0x280) (R/W 32) USART LON IDT Tx Register -------- */
#define FLEX_US_IDTTX_RESETVALUE              _UINT32_(0x00)                                       /*  (FLEX_US_IDTTX) USART LON IDT Tx Register  Reset Value */

#define FLEX_US_IDTTX_IDTTX_Pos               _UINT32_(0)                                          /* (FLEX_US_IDTTX) LON Indeterminate Time after Transmission (comm_type = 1 mode only) Position */
#define FLEX_US_IDTTX_IDTTX_Msk               (_UINT32_(0xFFFFFF) << FLEX_US_IDTTX_IDTTX_Pos)      /* (FLEX_US_IDTTX) LON Indeterminate Time after Transmission (comm_type = 1 mode only) Mask */
#define FLEX_US_IDTTX_IDTTX(value)            (FLEX_US_IDTTX_IDTTX_Msk & (_UINT32_(value) << FLEX_US_IDTTX_IDTTX_Pos)) /* Assigment of value for IDTTX in the FLEX_US_IDTTX register */
#define FLEX_US_IDTTX_Msk                     _UINT32_(0x00FFFFFF)                                 /* (FLEX_US_IDTTX) Register Mask  */


/* -------- FLEX_US_IDTRX : (FLEXCOM Offset: 0x284) (R/W 32) USART LON IDT Rx Register -------- */
#define FLEX_US_IDTRX_RESETVALUE              _UINT32_(0x00)                                       /*  (FLEX_US_IDTRX) USART LON IDT Rx Register  Reset Value */

#define FLEX_US_IDTRX_IDTRX_Pos               _UINT32_(0)                                          /* (FLEX_US_IDTRX) LON Indeterminate Time after Reception (comm_type = 1 mode only) Position */
#define FLEX_US_IDTRX_IDTRX_Msk               (_UINT32_(0xFFFFFF) << FLEX_US_IDTRX_IDTRX_Pos)      /* (FLEX_US_IDTRX) LON Indeterminate Time after Reception (comm_type = 1 mode only) Mask */
#define FLEX_US_IDTRX_IDTRX(value)            (FLEX_US_IDTRX_IDTRX_Msk & (_UINT32_(value) << FLEX_US_IDTRX_IDTRX_Pos)) /* Assigment of value for IDTRX in the FLEX_US_IDTRX register */
#define FLEX_US_IDTRX_Msk                     _UINT32_(0x00FFFFFF)                                 /* (FLEX_US_IDTRX) Register Mask  */


/* -------- FLEX_US_ICDIFF : (FLEXCOM Offset: 0x288) (R/W 32) USART IC DIFF Register -------- */
#define FLEX_US_ICDIFF_RESETVALUE             _UINT32_(0x00)                                       /*  (FLEX_US_ICDIFF) USART IC DIFF Register  Reset Value */

#define FLEX_US_ICDIFF_ICDIFF_Pos             _UINT32_(0)                                          /* (FLEX_US_ICDIFF) IC Differentiator Number Position */
#define FLEX_US_ICDIFF_ICDIFF_Msk             (_UINT32_(0xF) << FLEX_US_ICDIFF_ICDIFF_Pos)         /* (FLEX_US_ICDIFF) IC Differentiator Number Mask */
#define FLEX_US_ICDIFF_ICDIFF(value)          (FLEX_US_ICDIFF_ICDIFF_Msk & (_UINT32_(value) << FLEX_US_ICDIFF_ICDIFF_Pos)) /* Assigment of value for ICDIFF in the FLEX_US_ICDIFF register */
#define FLEX_US_ICDIFF_Msk                    _UINT32_(0x0000000F)                                 /* (FLEX_US_ICDIFF) Register Mask  */
...
#define FLEX_SPI_MR_CRCEN_Pos                 _UINT32_(6)                                          /* (FLEX_SPI_MR) CRC Enable Position */
#define FLEX_SPI_MR_CRCEN_Msk                 (_UINT32_(0x1) << FLEX_SPI_MR_CRCEN_Pos)             /* (FLEX_SPI_MR) CRC Enable Mask */
#define FLEX_SPI_MR_CRCEN(value)              (FLEX_SPI_MR_CRCEN_Msk & (_UINT32_(value) << FLEX_SPI_MR_CRCEN_Pos)) /* Assigment of value for CRCEN in the FLEX_SPI_MR register */
#define   FLEX_SPI_MR_CRCEN_0_Val             _UINT32_(0x0)                                        /* (FLEX_SPI_MR) CRC calculation is disabled.  */
#define   FLEX_SPI_MR_CRCEN_1_Val             _UINT32_(0x1)                                        /* (FLEX_SPI_MR) CRC calculation is enabled. BITS in FLEX_SPI_CSRx registers must be at value '0'.  */
#define FLEX_SPI_MR_CRCEN_0                   (FLEX_SPI_MR_CRCEN_0_Val << FLEX_SPI_MR_CRCEN_Pos)   /* (FLEX_SPI_MR) CRC calculation is disabled. Position  */
#define FLEX_SPI_MR_CRCEN_1                   (FLEX_SPI_MR_CRCEN_1_Val << FLEX_SPI_MR_CRCEN_Pos)   /* (FLEX_SPI_MR) CRC calculation is enabled. BITS in FLEX_SPI_CSRx registers must be at value '0'. Position  */
...
#define FLEX_SPI_MR_TPMEN_Pos                 _UINT32_(13)                                         /* (FLEX_SPI_MR) Two-Pin Mode Enable Position */
#define FLEX_SPI_MR_TPMEN_Msk                 (_UINT32_(0x1) << FLEX_SPI_MR_TPMEN_Pos)             /* (FLEX_SPI_MR) Two-Pin Mode Enable Mask */
#define FLEX_SPI_MR_TPMEN(value)              (FLEX_SPI_MR_TPMEN_Msk & (_UINT32_(value) << FLEX_SPI_MR_TPMEN_Pos)) /* Assigment of value for TPMEN in the FLEX_SPI_MR register */
#define   FLEX_SPI_MR_TPMEN_0_Val             _UINT32_(0x0)                                        /* (FLEX_SPI_MR) Two-Pin mode is disabled.  */
#define   FLEX_SPI_MR_TPMEN_1_Val             _UINT32_(0x1)                                        /* (FLEX_SPI_MR) Two-Pin mode is enabled.  */
#define FLEX_SPI_MR_TPMEN_0                   (FLEX_SPI_MR_TPMEN_0_Val << FLEX_SPI_MR_TPMEN_Pos)   /* (FLEX_SPI_MR) Two-Pin mode is disabled. Position  */
#define FLEX_SPI_MR_TPMEN_1                   (FLEX_SPI_MR_TPMEN_1_Val << FLEX_SPI_MR_TPMEN_Pos)   /* (FLEX_SPI_MR) Two-Pin mode is enabled. Position  */
#define FLEX_SPI_MR_CSIE_Pos                  _UINT32_(14)                                         /* (FLEX_SPI_MR) Chip Select Inversion Enable Position */
#define FLEX_SPI_MR_CSIE_Msk                  (_UINT32_(0x1) << FLEX_SPI_MR_CSIE_Pos)              /* (FLEX_SPI_MR) Chip Select Inversion Enable Mask */
#define FLEX_SPI_MR_CSIE(value)               (FLEX_SPI_MR_CSIE_Msk & (_UINT32_(value) << FLEX_SPI_MR_CSIE_Pos)) /* Assigment of value for CSIE in the FLEX_SPI_MR register */
#define   FLEX_SPI_MR_CSIE_0_Val              _UINT32_(0x0)                                        /* (FLEX_SPI_MR) Chip select NPCS active polarity is low.  */
#define   FLEX_SPI_MR_CSIE_1_Val              _UINT32_(0x1)                                        /* (FLEX_SPI_MR) Chip select NPCS active polarity is high.  */
#define FLEX_SPI_MR_CSIE_0                    (FLEX_SPI_MR_CSIE_0_Val << FLEX_SPI_MR_CSIE_Pos)     /* (FLEX_SPI_MR) Chip select NPCS active polarity is low. Position  */
#define FLEX_SPI_MR_CSIE_1                    (FLEX_SPI_MR_CSIE_1_Val << FLEX_SPI_MR_CSIE_Pos)     /* (FLEX_SPI_MR) Chip select NPCS active polarity is high. Position  */
#define FLEX_SPI_MR_MOSIIE_Pos                _UINT32_(15)                                         /* (FLEX_SPI_MR) MOSI Inversion Enable Position */
#define FLEX_SPI_MR_MOSIIE_Msk                (_UINT32_(0x1) << FLEX_SPI_MR_MOSIIE_Pos)            /* (FLEX_SPI_MR) MOSI Inversion Enable Mask */
#define FLEX_SPI_MR_MOSIIE(value)             (FLEX_SPI_MR_MOSIIE_Msk & (_UINT32_(value) << FLEX_SPI_MR_MOSIIE_Pos)) /* Assigment of value for MOSIIE in the FLEX_SPI_MR register */
#define   FLEX_SPI_MR_MOSIIE_0_Val            _UINT32_(0x0)                                        /* (FLEX_SPI_MR) MOSI input is not inverted.  */
#define   FLEX_SPI_MR_MOSIIE_1_Val            _UINT32_(0x1)                                        /* (FLEX_SPI_MR) MOSI input is internally inverted before being processed by the SPI.  */
#define FLEX_SPI_MR_MOSIIE_0                  (FLEX_SPI_MR_MOSIIE_0_Val << FLEX_SPI_MR_MOSIIE_Pos) /* (FLEX_SPI_MR) MOSI input is not inverted. Position  */
#define FLEX_SPI_MR_MOSIIE_1                  (FLEX_SPI_MR_MOSIIE_1_Val << FLEX_SPI_MR_MOSIIE_Pos) /* (FLEX_SPI_MR) MOSI input is internally inverted before being processed by the SPI. Position  */
...
#define FLEX_SPI_SR_CRCERR_Pos                _UINT32_(13)                                         /* (FLEX_SPI_SR) CRC Error (cleared on read) Position */
#define FLEX_SPI_SR_CRCERR_Msk                (_UINT32_(0x1) << FLEX_SPI_SR_CRCERR_Pos)            /* (FLEX_SPI_SR) CRC Error (cleared on read) Mask */
#define FLEX_SPI_SR_CRCERR(value)             (FLEX_SPI_SR_CRCERR_Msk & (_UINT32_(value) << FLEX_SPI_SR_CRCERR_Pos)) /* Assigment of value for CRCERR in the FLEX_SPI_SR register */
#define   FLEX_SPI_SR_CRCERR_0_Val            _UINT32_(0x0)                                        /* (FLEX_SPI_SR) CRC calculation is disabled or no received frame contains a CRC error since the last read of FLEX_SPI_SR.  */
#define   FLEX_SPI_SR_CRCERR_1_Val            _UINT32_(0x1)                                        /* (FLEX_SPI_SR) Since the last read of FLEX_SPI_SR, a received frame contains a CRC error.  */
#define FLEX_SPI_SR_CRCERR_0                  (FLEX_SPI_SR_CRCERR_0_Val << FLEX_SPI_SR_CRCERR_Pos) /* (FLEX_SPI_SR) CRC calculation is disabled or no received frame contains a CRC error since the last read of FLEX_SPI_SR. Position  */
#define FLEX_SPI_SR_CRCERR_1                  (FLEX_SPI_SR_CRCERR_1_Val << FLEX_SPI_SR_CRCERR_Pos) /* (FLEX_SPI_SR) Since the last read of FLEX_SPI_SR, a received frame contains a CRC error. Position  */
...
#define FLEX_SPI_SR_Msk                       _UINT32_(0xFF013F0F)                                 /* (FLEX_SPI_SR) Register Mask  */
...
#define FLEX_SPI_IER_CRCERR_Pos               _UINT32_(13)                                         /* (FLEX_SPI_IER) CRC Error Interrupt Enable Position */
#define FLEX_SPI_IER_CRCERR_Msk               (_UINT32_(0x1) << FLEX_SPI_IER_CRCERR_Pos)           /* (FLEX_SPI_IER) CRC Error Interrupt Enable Mask */
#define FLEX_SPI_IER_CRCERR(value)            (FLEX_SPI_IER_CRCERR_Msk & (_UINT32_(value) << FLEX_SPI_IER_CRCERR_Pos)) /* Assigment of value for CRCERR in the FLEX_SPI_IER register */
...
#define FLEX_SPI_IER_Msk                      _UINT32_(0xFF003F0F)                                 /* (FLEX_SPI_IER) Register Mask  */
...
#define FLEX_SPI_IDR_CRCERR_Pos               _UINT32_(13)                                         /* (FLEX_SPI_IDR) CRC Error Interrupt Disable Position */
#define FLEX_SPI_IDR_CRCERR_Msk               (_UINT32_(0x1) << FLEX_SPI_IDR_CRCERR_Pos)           /* (FLEX_SPI_IDR) CRC Error Interrupt Disable Mask */
#define FLEX_SPI_IDR_CRCERR(value)            (FLEX_SPI_IDR_CRCERR_Msk & (_UINT32_(value) << FLEX_SPI_IDR_CRCERR_Pos)) /* Assigment of value for CRCERR in the FLEX_SPI_IDR register */
...
#define FLEX_SPI_IDR_Msk                      _UINT32_(0xFF003F0F)                                 /* (FLEX_SPI_IDR) Register Mask  */
...
#define FLEX_SPI_IMR_CRCERR_Pos               _UINT32_(13)                                         /* (FLEX_SPI_IMR) CRC Error Interrupt Mask Position */
#define FLEX_SPI_IMR_CRCERR_Msk               (_UINT32_(0x1) << FLEX_SPI_IMR_CRCERR_Pos)           /* (FLEX_SPI_IMR) CRC Error Interrupt Mask Mask */
#define FLEX_SPI_IMR_CRCERR(value)            (FLEX_SPI_IMR_CRCERR_Msk & (_UINT32_(value) << FLEX_SPI_IMR_CRCERR_Pos)) /* Assigment of value for CRCERR in the FLEX_SPI_IMR register */
...
#define FLEX_SPI_IMR_Msk                      _UINT32_(0xFF003F0F)                                 /* (FLEX_SPI_IMR) Register Mask  */
...
/* -------- FLEX_SPI_CRCR : (FLEXCOM Offset: 0x44C) (R/W 32) SPI CRC Register -------- */
#define FLEX_SPI_CRCR_RESETVALUE              _UINT32_(0x00)                                       /*  (FLEX_SPI_CRCR) SPI CRC Register  Reset Value */

#define FLEX_SPI_CRCR_FRL_Pos                 _UINT32_(0)                                          /* (FLEX_SPI_CRCR) Frame Length Position */
#define FLEX_SPI_CRCR_FRL_Msk                 (_UINT32_(0xFF) << FLEX_SPI_CRCR_FRL_Pos)            /* (FLEX_SPI_CRCR) Frame Length Mask */
#define FLEX_SPI_CRCR_FRL(value)              (FLEX_SPI_CRCR_FRL_Msk & (_UINT32_(value) << FLEX_SPI_CRCR_FRL_Pos)) /* Assigment of value for FRL in the FLEX_SPI_CRCR register */
#define FLEX_SPI_CRCR_CRCS_Pos                _UINT32_(16)                                         /* (FLEX_SPI_CRCR) CRC Size Position */
#define FLEX_SPI_CRCR_CRCS_Msk                (_UINT32_(0x1) << FLEX_SPI_CRCR_CRCS_Pos)            /* (FLEX_SPI_CRCR) CRC Size Mask */
#define FLEX_SPI_CRCR_CRCS(value)             (FLEX_SPI_CRCR_CRCS_Msk & (_UINT32_(value) << FLEX_SPI_CRCR_CRCS_Pos)) /* Assigment of value for CRCS in the FLEX_SPI_CRCR register */
#define   FLEX_SPI_CRCR_CRCS_16B_CRC_Val      _UINT32_(0x0)                                        /* (FLEX_SPI_CRCR) CRC size is 16 bits.  */
#define   FLEX_SPI_CRCR_CRCS_32B_CRC_Val      _UINT32_(0x1)                                        /* (FLEX_SPI_CRCR) CRC size is 32 bits.  */
#define FLEX_SPI_CRCR_CRCS_16B_CRC            (FLEX_SPI_CRCR_CRCS_16B_CRC_Val << FLEX_SPI_CRCR_CRCS_Pos) /* (FLEX_SPI_CRCR) CRC size is 16 bits. Position  */
#define FLEX_SPI_CRCR_CRCS_32B_CRC            (FLEX_SPI_CRCR_CRCS_32B_CRC_Val << FLEX_SPI_CRCR_CRCS_Pos) /* (FLEX_SPI_CRCR) CRC size is 32 bits. Position  */
#define FLEX_SPI_CRCR_FRHL_Pos                _UINT32_(20)                                         /* (FLEX_SPI_CRCR) Frame Header Length Position */
#define FLEX_SPI_CRCR_FRHL_Msk                (_UINT32_(0xF) << FLEX_SPI_CRCR_FRHL_Pos)            /* (FLEX_SPI_CRCR) Frame Header Length Mask */
#define FLEX_SPI_CRCR_FRHL(value)             (FLEX_SPI_CRCR_FRHL_Msk & (_UINT32_(value) << FLEX_SPI_CRCR_FRHL_Pos)) /* Assigment of value for FRHL in the FLEX_SPI_CRCR register */
#define FLEX_SPI_CRCR_CRM_Pos                 _UINT32_(24)                                         /* (FLEX_SPI_CRCR) Continuous Read Mode Position */
#define FLEX_SPI_CRCR_CRM_Msk                 (_UINT32_(0x1) << FLEX_SPI_CRCR_CRM_Pos)             /* (FLEX_SPI_CRCR) Continuous Read Mode Mask */
#define FLEX_SPI_CRCR_CRM(value)              (FLEX_SPI_CRCR_CRM_Msk & (_UINT32_(value) << FLEX_SPI_CRCR_CRM_Pos)) /* Assigment of value for CRM in the FLEX_SPI_CRCR register */
#define   FLEX_SPI_CRCR_CRM_0_Val             _UINT32_(0x0)                                        /* (FLEX_SPI_CRCR) A header is sent every frame in case of contiguous frames (without de-asserting the corresponding NPCS).  */
#define   FLEX_SPI_CRCR_CRM_1_Val             _UINT32_(0x1)                                        /* (FLEX_SPI_CRCR) A header is sent only on the first frame in case of contiguous frames (without de-asserting the corresponding NPCS).  */
#define FLEX_SPI_CRCR_CRM_0                   (FLEX_SPI_CRCR_CRM_0_Val << FLEX_SPI_CRCR_CRM_Pos)   /* (FLEX_SPI_CRCR) A header is sent every frame in case of contiguous frames (without de-asserting the corresponding NPCS). Position  */
#define FLEX_SPI_CRCR_CRM_1                   (FLEX_SPI_CRCR_CRM_1_Val << FLEX_SPI_CRCR_CRM_Pos)   /* (FLEX_SPI_CRCR) A header is sent only on the first frame in case of contiguous frames (without de-asserting the corresponding NPCS). Position  */
#define FLEX_SPI_CRCR_FHE_Pos                 _UINT32_(25)                                         /* (FLEX_SPI_CRCR) Frame Header Excluded Position */
#define FLEX_SPI_CRCR_FHE_Msk                 (_UINT32_(0x1) << FLEX_SPI_CRCR_FHE_Pos)             /* (FLEX_SPI_CRCR) Frame Header Excluded Mask */
#define FLEX_SPI_CRCR_FHE(value)              (FLEX_SPI_CRCR_FHE_Msk & (_UINT32_(value) << FLEX_SPI_CRCR_FHE_Pos)) /* Assigment of value for FHE in the FLEX_SPI_CRCR register */
#define   FLEX_SPI_CRCR_FHE_0_Val             _UINT32_(0x0)                                        /* (FLEX_SPI_CRCR) The frame header is included in the CRC calculation.  */
#define   FLEX_SPI_CRCR_FHE_1_Val             _UINT32_(0x1)                                        /* (FLEX_SPI_CRCR) The frame header is excluded from the CRC calculation.  */
#define FLEX_SPI_CRCR_FHE_0                   (FLEX_SPI_CRCR_FHE_0_Val << FLEX_SPI_CRCR_FHE_Pos)   /* (FLEX_SPI_CRCR) The frame header is included in the CRC calculation. Position  */
#define FLEX_SPI_CRCR_FHE_1                   (FLEX_SPI_CRCR_FHE_1_Val << FLEX_SPI_CRCR_FHE_Pos)   /* (FLEX_SPI_CRCR) The frame header is excluded from the CRC calculation. Position  */
#define FLEX_SPI_CRCR_DCRX_Pos                _UINT32_(26)                                         /* (FLEX_SPI_CRCR) Disable CRC Receiving Position */
#define FLEX_SPI_CRCR_DCRX_Msk                (_UINT32_(0x1) << FLEX_SPI_CRCR_DCRX_Pos)            /* (FLEX_SPI_CRCR) Disable CRC Receiving Mask */
#define FLEX_SPI_CRCR_DCRX(value)             (FLEX_SPI_CRCR_DCRX_Msk & (_UINT32_(value) << FLEX_SPI_CRCR_DCRX_Pos)) /* Assigment of value for DCRX in the FLEX_SPI_CRCR register */
#define   FLEX_SPI_CRCR_DCRX_0_Val            _UINT32_(0x0)                                        /* (FLEX_SPI_CRCR) CRC is received and supplied to FLEX_SPI_RDR as a classic data.  */
#define   FLEX_SPI_CRCR_DCRX_1_Val            _UINT32_(0x1)                                        /* (FLEX_SPI_CRCR) CRC is received and checked but not supplied to FLEX_SPI_RDR (RDRF will not rise upon CRC receiving).  */
#define FLEX_SPI_CRCR_DCRX_0                  (FLEX_SPI_CRCR_DCRX_0_Val << FLEX_SPI_CRCR_DCRX_Pos) /* (FLEX_SPI_CRCR) CRC is received and supplied to FLEX_SPI_RDR as a classic data. Position  */
#define FLEX_SPI_CRCR_DCRX_1                  (FLEX_SPI_CRCR_DCRX_1_Val << FLEX_SPI_CRCR_DCRX_Pos) /* (FLEX_SPI_CRCR) CRC is received and checked but not supplied to FLEX_SPI_RDR (RDRF will not rise upon CRC receiving). Position  */
#define FLEX_SPI_CRCR_DHRX_Pos                _UINT32_(27)                                         /* (FLEX_SPI_CRCR) Disable Header Receiving Position */
#define FLEX_SPI_CRCR_DHRX_Msk                (_UINT32_(0x1) << FLEX_SPI_CRCR_DHRX_Pos)            /* (FLEX_SPI_CRCR) Disable Header Receiving Mask */
#define FLEX_SPI_CRCR_DHRX(value)             (FLEX_SPI_CRCR_DHRX_Msk & (_UINT32_(value) << FLEX_SPI_CRCR_DHRX_Pos)) /* Assigment of value for DHRX in the FLEX_SPI_CRCR register */
#define   FLEX_SPI_CRCR_DHRX_0_Val            _UINT32_(0x0)                                        /* (FLEX_SPI_CRCR) Header is received and supplied to FLEX_SPI_RDR as a classic data.  */
#define   FLEX_SPI_CRCR_DHRX_1_Val            _UINT32_(0x1)                                        /* (FLEX_SPI_CRCR) Header is received and checked but not supplied to FLEX_SPI_RDR (RDRF will not rise upon Header receiving).  */
#define FLEX_SPI_CRCR_DHRX_0                  (FLEX_SPI_CRCR_DHRX_0_Val << FLEX_SPI_CRCR_DHRX_Pos) /* (FLEX_SPI_CRCR) Header is received and supplied to FLEX_SPI_RDR as a classic data. Position  */
#define FLEX_SPI_CRCR_DHRX_1                  (FLEX_SPI_CRCR_DHRX_1_Val << FLEX_SPI_CRCR_DHRX_Pos) /* (FLEX_SPI_CRCR) Header is received and checked but not supplied to FLEX_SPI_RDR (RDRF will not rise upon Header receiving). Position  */
#define FLEX_SPI_CRCR_Msk                     _UINT32_(0x0FF100FF)                                 /* (FLEX_SPI_CRCR) Register Mask  */


/* -------- FLEX_SPI_TPMR : (FLEXCOM Offset: 0x450) (R/W 32) SPI Two-Pin Mode Register -------- */
#define FLEX_SPI_TPMR_RESETVALUE              _UINT32_(0x00)                                       /*  (FLEX_SPI_TPMR) SPI Two-Pin Mode Register  Reset Value */

#define FLEX_SPI_TPMR_CSM_Pos                 _UINT32_(0)                                          /* (FLEX_SPI_TPMR) Chip Select Mode Position */
#define FLEX_SPI_TPMR_CSM_Msk                 (_UINT32_(0x1) << FLEX_SPI_TPMR_CSM_Pos)             /* (FLEX_SPI_TPMR) Chip Select Mode Mask */
#define FLEX_SPI_TPMR_CSM(value)              (FLEX_SPI_TPMR_CSM_Msk & (_UINT32_(value) << FLEX_SPI_TPMR_CSM_Pos)) /* Assigment of value for CSM in the FLEX_SPI_TPMR register */
#define   FLEX_SPI_TPMR_CSM_0_Val             _UINT32_(0x0)                                        /* (FLEX_SPI_TPMR) Chip select is not driven.  */
#define   FLEX_SPI_TPMR_CSM_1_Val             _UINT32_(0x1)                                        /* (FLEX_SPI_TPMR) Chip select is driven and can be used to control enable pin of external device. Depending on FLEX_SPI_MR.PCSDEC, an external decoder can be used to minimize the number of IOs used.  */
#define FLEX_SPI_TPMR_CSM_0                   (FLEX_SPI_TPMR_CSM_0_Val << FLEX_SPI_TPMR_CSM_Pos)   /* (FLEX_SPI_TPMR) Chip select is not driven. Position  */
#define FLEX_SPI_TPMR_CSM_1                   (FLEX_SPI_TPMR_CSM_1_Val << FLEX_SPI_TPMR_CSM_Pos)   /* (FLEX_SPI_TPMR) Chip select is driven and can be used to control enable pin of external device. Depending on FLEX_SPI_MR.PCSDEC, an external decoder can be used to minimize the number of IOs used. Position  */
#define FLEX_SPI_TPMR_ALWAYS0_Pos             _UINT32_(1)                                          /* (FLEX_SPI_TPMR) Always Written to 0 Position */
#define FLEX_SPI_TPMR_ALWAYS0_Msk             (_UINT32_(0x1) << FLEX_SPI_TPMR_ALWAYS0_Pos)         /* (FLEX_SPI_TPMR) Always Written to 0 Mask */
#define FLEX_SPI_TPMR_ALWAYS0(value)          (FLEX_SPI_TPMR_ALWAYS0_Msk & (_UINT32_(value) << FLEX_SPI_TPMR_ALWAYS0_Pos)) /* Assigment of value for ALWAYS0 in the FLEX_SPI_TPMR register */
#define FLEX_SPI_TPMR_OSR_Pos                 _UINT32_(2)                                          /* (FLEX_SPI_TPMR) OverSampling Rate Position */
#define FLEX_SPI_TPMR_OSR_Msk                 (_UINT32_(0x3) << FLEX_SPI_TPMR_OSR_Pos)             /* (FLEX_SPI_TPMR) OverSampling Rate Mask */
#define FLEX_SPI_TPMR_OSR(value)              (FLEX_SPI_TPMR_OSR_Msk & (_UINT32_(value) << FLEX_SPI_TPMR_OSR_Pos)) /* Assigment of value for OSR in the FLEX_SPI_TPMR register */
#define FLEX_SPI_TPMR_Msk                     _UINT32_(0x0000000F)                                 /* (FLEX_SPI_TPMR) Register Mask  */

#define FLEX_SPI_TPMR_ALWAYS_Pos              _UINT32_(1)                                          /* (FLEX_SPI_TPMR Position) Always Written to x */
#define FLEX_SPI_TPMR_ALWAYS_Msk              (_UINT32_(0x1) << FLEX_SPI_TPMR_ALWAYS_Pos)          /* (FLEX_SPI_TPMR Mask) ALWAYS */
#define FLEX_SPI_TPMR_ALWAYS(value)           (FLEX_SPI_TPMR_ALWAYS_Msk & (_UINT32_(value) << FLEX_SPI_TPMR_ALWAYS_Pos)) 

/* -------- FLEX_SPI_TPHR : (FLEXCOM Offset: 0x454) ( R/ 32) SPI Two-Pin Header Register -------- */
#define FLEX_SPI_TPHR_RESETVALUE              _UINT32_(0x00)                                       /*  (FLEX_SPI_TPHR) SPI Two-Pin Header Register  Reset Value */

#define FLEX_SPI_TPHR_CNT_Pos                 _UINT32_(0)                                          /* (FLEX_SPI_TPHR) Frame Counter Position */
#define FLEX_SPI_TPHR_CNT_Msk                 (_UINT32_(0x3) << FLEX_SPI_TPHR_CNT_Pos)             /* (FLEX_SPI_TPHR) Frame Counter Mask */
#define FLEX_SPI_TPHR_CNT(value)              (FLEX_SPI_TPHR_CNT_Msk & (_UINT32_(value) << FLEX_SPI_TPHR_CNT_Pos)) /* Assigment of value for CNT in the FLEX_SPI_TPHR register */
#define FLEX_SPI_TPHR_BOOST_Pos               _UINT32_(2)                                          /* (FLEX_SPI_TPHR) Current Boost Position */
#define FLEX_SPI_TPHR_BOOST_Msk               (_UINT32_(0x1) << FLEX_SPI_TPHR_BOOST_Pos)           /* (FLEX_SPI_TPHR) Current Boost Mask */
#define FLEX_SPI_TPHR_BOOST(value)            (FLEX_SPI_TPHR_BOOST_Msk & (_UINT32_(value) << FLEX_SPI_TPHR_BOOST_Pos)) /* Assigment of value for BOOST in the FLEX_SPI_TPHR register */
#define FLEX_SPI_TPHR_GAIN_Pos                _UINT32_(3)                                          /* (FLEX_SPI_TPHR) Gain Position */
#define FLEX_SPI_TPHR_GAIN_Msk                (_UINT32_(0x3) << FLEX_SPI_TPHR_GAIN_Pos)            /* (FLEX_SPI_TPHR) Gain Mask */
#define FLEX_SPI_TPHR_GAIN(value)             (FLEX_SPI_TPHR_GAIN_Msk & (_UINT32_(value) << FLEX_SPI_TPHR_GAIN_Pos)) /* Assigment of value for GAIN in the FLEX_SPI_TPHR register */
#define FLEX_SPI_TPHR_OSR_Pos                 _UINT32_(5)                                          /* (FLEX_SPI_TPHR) OverSampling Rate Position */
#define FLEX_SPI_TPHR_OSR_Msk                 (_UINT32_(0x3) << FLEX_SPI_TPHR_OSR_Pos)             /* (FLEX_SPI_TPHR) OverSampling Rate Mask */
#define FLEX_SPI_TPHR_OSR(value)              (FLEX_SPI_TPHR_OSR_Msk & (_UINT32_(value) << FLEX_SPI_TPHR_OSR_Pos)) /* Assigment of value for OSR in the FLEX_SPI_TPHR register */
#define FLEX_SPI_TPHR_Msk                     _UINT32_(0x0000007F)                                 /* (FLEX_SPI_TPHR) Register Mask  */
...
#define FLEX_TWI_CR_FIFO_ENABLED_Msk          _UINT32_(0x37000000)                                  /* (FLEX_TWI_CR_FIFO_ENABLED) Register Mask  */
...
#define FLEX_TWI_SMR_Msk                      _UINT32_(0x007F7FFD)                                 /* (FLEX_TWI_SMR) Register Mask  */
...
#define FLEX_TWI_CWGR_HOLD_Msk                (_UINT32_(0x7F) << FLEX_TWI_CWGR_HOLD_Pos)           /* (FLEX_TWI_CWGR) TWD Hold Time Versus TWCK Falling Mask */
...
#define FLEX_TWI_CWGR_Msk                     _UINT32_(0x7F17FFFF)                                 /* (FLEX_TWI_CWGR) Register Mask  */
...
#define FLEX_US_LONMR_REG_OFST         _UINT32_(0x260)     /* (FLEX_US_LONMR) USART LON Mode Register Offset */
#define FLEX_US_LONPR_REG_OFST         _UINT32_(0x264)     /* (FLEX_US_LONPR) USART LON Preamble Register Offset */
#define FLEX_US_LONDL_REG_OFST         _UINT32_(0x268)     /* (FLEX_US_LONDL) USART LON Data Length Register Offset */
#define FLEX_US_LONL2HDR_REG_OFST      _UINT32_(0x26C)     /* (FLEX_US_LONL2HDR) USART LON L2HDR Register Offset */
#define FLEX_US_LONBL_REG_OFST         _UINT32_(0x270)     /* (FLEX_US_LONBL) USART LON Backlog Register Offset */
#define FLEX_US_LONB1TX_REG_OFST       _UINT32_(0x274)     /* (FLEX_US_LONB1TX) USART LON Beta1 Tx Register Offset */
#define FLEX_US_LONB1RX_REG_OFST       _UINT32_(0x278)     /* (FLEX_US_LONB1RX) USART LON Beta1 Rx Register Offset */
#define FLEX_US_LONPRIO_REG_OFST       _UINT32_(0x27C)     /* (FLEX_US_LONPRIO) USART LON Priority Register Offset */
#define FLEX_US_IDTTX_REG_OFST         _UINT32_(0x280)     /* (FLEX_US_IDTTX) USART LON IDT Tx Register Offset */
#define FLEX_US_IDTRX_REG_OFST         _UINT32_(0x284)     /* (FLEX_US_IDTRX) USART LON IDT Rx Register Offset */
#define FLEX_US_ICDIFF_REG_OFST        _UINT32_(0x288)     /* (FLEX_US_ICDIFF) USART IC DIFF Register Offset */
...
#define FLEX_SPI_CRCR_REG_OFST         _UINT32_(0x44C)     /* (FLEX_SPI_CRCR) SPI CRC Register Offset */
#define FLEX_SPI_TPMR_REG_OFST         _UINT32_(0x450)     /* (FLEX_SPI_TPMR) SPI Two-Pin Mode Register Offset */
#define FLEX_SPI_TPHR_REG_OFST         _UINT32_(0x454)     /* (FLEX_SPI_TPHR) SPI Two-Pin Header Register Offset */
...
{  /* Flexible Serial Communication */
  ...
  __IO  uint32_t                       FLEX_SPI_CRCR;      /**< Offset: 0x44C (R/W  32) SPI CRC Register */
  __IO  uint32_t                       FLEX_SPI_TPMR;      /**< Offset: 0x450 (R/W  32) SPI Two-Pin Mode Register */
  __I   uint32_t                       FLEX_SPI_TPHR;      /**< Offset: 0x454 (R/   32) SPI Two-Pin Header Register */
  __I   uint8_t                        Reserved11[0x8C];
...
#endif /* _SAM9X7_FLEXCOM_COMPONENT_H_ */
