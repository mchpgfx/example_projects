...
#define AIC_SMR_PRIOR(value)                  (AIC_SMR_PRIOR_Msk & (_UINT32_(value) << AIC_SMR_PRIOR_Pos)) /* Assigment of value for PRIOR in the AIC_SMR register */
...
#define AIC_IPR0_SYS(value)                   (AIC_IPR0_SYS_Msk & (_UINT32_(value) << AIC_IPR0_SYS_Pos)) /* Assigment of value for SYS in the AIC_IPR0 register */
...
#define AIC_IPR2_PID74(value)                 (AIC_IPR2_PID74_Msk & (_UINT32_(value) << AIC_IPR2_PID74_Pos)) /* Assigment of value for PID74 in the AIC_IPR2 register */
...
#define AIC_FFER_FFEN(value)                  (AIC_FFER_FFEN_Msk & (_UINT32_(value) << AIC_FFER_FFEN_Pos)) /* Assigment of value for FFEN in the AIC_FFER register */
...
#define AIC_FFDR_FFDIS(value)                 (AIC_FFDR_FFDIS_Msk & (_UINT32_(value) << AIC_FFDR_FFDIS_Pos)) /* Assigment of value for FFDIS in the AIC_FFDR register */
...
#define AIC_FFSR_FFS(value)                   (AIC_FFSR_FFS_Msk & (_UINT32_(value) << AIC_FFSR_FFS_Pos)) /* Assigment of value for FFS in the AIC_FFSR register */
...
#define AIC_SVRRER_SVRREN(value)              (AIC_SVRRER_SVRREN_Msk & (_UINT32_(value) << AIC_SVRRER_SVRREN_Pos)) /* Assigment of value for SVRREN in the AIC_SVRRER register */
...
#define AIC_SVRRDR_SVRRDIS(value)             (AIC_SVRRDR_SVRRDIS_Msk & (_UINT32_(value) << AIC_SVRRDR_SVRRDIS_Pos)) /* Assigment of value for SVRRDIS in the AIC_SVRRDR register */
...
#define AIC_SVRRSR_SVRRS(value)               (AIC_SVRRSR_SVRRS_Msk & (_UINT32_(value) << AIC_SVRRSR_SVRRS_Pos)) /* Assigment of value for SVRRS in the AIC_SVRRSR register */
