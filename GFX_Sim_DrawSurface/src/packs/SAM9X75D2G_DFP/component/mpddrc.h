...
#define MPDDRC_CR_SUP_DDR3(value)             (MPDDRC_CR_SUP_DDR3_Msk & (_UINT32_(value) << MPDDRC_CR_SUP_DDR3_Pos)) /* Assigment of value for SUP_DDR3 in the MPDDRC_CR register */
...
#define MPDDRC_CR_CAS_WR(value)               (MPDDRC_CR_CAS_WR_Msk & (_UINT32_(value) << MPDDRC_CR_CAS_WR_Pos)) /* Assigment of value for CAS_WR in the MPDDRC_CR register */
...
#define MPDDRC_TPR2_TMOD(value)               (MPDDRC_TPR2_TMOD_Msk & (_UINT32_(value) << MPDDRC_TPR2_TMOD_Pos)) /* Assigment of value for TMOD in the MPDDRC_TPR2 register */
...
#define MPDDRC_LPR_SELFAUTO(value)            (MPDDRC_LPR_SELFAUTO_Msk & (_UINT32_(value) << MPDDRC_LPR_SELFAUTO_Pos)) /* Assigment of value for SELFAUTO in the MPDDRC_LPR register */
...
#define MPDDRC_LPR_SRT(value)                 (MPDDRC_LPR_SRT_Msk & (_UINT32_(value) << MPDDRC_LPR_SRT_Pos)) /* Assigment of value for SRT in the MPDDRC_LPR register */
...
#define MPDDRC_LPR_ASR(value)                 (MPDDRC_LPR_ASR_Msk & (_UINT32_(value) << MPDDRC_LPR_ASR_Pos)) /* Assigment of value for ASR in the MPDDRC_LPR register */
...
#define MPDDRC_DDR3_CAL_COUNT_CAL(value)      (MPDDRC_DDR3_CAL_COUNT_CAL_Msk & (_UINT32_(value) << MPDDRC_DDR3_CAL_COUNT_CAL_Pos)) /* Assigment of value for COUNT_CAL in the MPDDRC_DDR3_CAL register */
...
#define MPDDRC_DDR3_TIM_CAL_ZQCS(value)       (MPDDRC_DDR3_TIM_CAL_ZQCS_Msk & (_UINT32_(value) << MPDDRC_DDR3_TIM_CAL_ZQCS_Pos)) /* Assigment of value for ZQCS in the MPDDRC_DDR3_TIM_CAL register */
...
#define MPDDRC_OCMS_TAMPCLR(value)            (MPDDRC_OCMS_TAMPCLR_Msk & (_UINT32_(value) << MPDDRC_OCMS_TAMPCLR_Pos)) /* Assigment of value for TAMPCLR in the MPDDRC_OCMS register */
...
#define MPDDRC_CONF_ARBITER_KEEP_LAYER(value) (MPDDRC_CONF_ARBITER_KEEP_LAYER_Msk & (_UINT32_(value) << MPDDRC_CONF_ARBITER_KEEP_LAYER_Pos)) /* Assigment of value for KEEP_LAYER in the MPDDRC_CONF_ARBITER register */
...
#define MPDDRC_REQ_PORT_456_NRQ_NWD_BDW_P4(value) (MPDDRC_REQ_PORT_456_NRQ_NWD_BDW_P4_Msk & (_UINT32_(value) << MPDDRC_REQ_PORT_456_NRQ_NWD_BDW_P4_Pos)) /* Assigment of value for NRQ_NWD_BDW_P4 in the MPDDRC_REQ_PORT_456 register */
...
#define MPDDRC_REQ_PORT_456_NRQ_NWD_BDW_P5(value) (MPDDRC_REQ_PORT_456_NRQ_NWD_BDW_P5_Msk & (_UINT32_(value) << MPDDRC_REQ_PORT_456_NRQ_NWD_BDW_P5_Pos)) /* Assigment of value for NRQ_NWD_BDW_P5 in the MPDDRC_REQ_PORT_456 register */
...
#define MPDDRC_REQ_PORT_456_NRQ_NWD_BDW_P6(value) (MPDDRC_REQ_PORT_456_NRQ_NWD_BDW_P6_Msk & (_UINT32_(value) << MPDDRC_REQ_PORT_456_NRQ_NWD_BDW_P6_Pos)) /* Assigment of value for NRQ_NWD_BDW_P6 in the MPDDRC_REQ_PORT_456 register */
...
#define MPDDRC_BDW_PORT_456_BDW_P4(value)     (MPDDRC_BDW_PORT_456_BDW_P4_Msk & (_UINT32_(value) << MPDDRC_BDW_PORT_456_BDW_P4_Pos)) /* Assigment of value for BDW_P4 in the MPDDRC_BDW_PORT_456 register */
...
#define MPDDRC_BDW_PORT_456_BDW_P5(value)     (MPDDRC_BDW_PORT_456_BDW_P5_Msk & (_UINT32_(value) << MPDDRC_BDW_PORT_456_BDW_P5_Pos)) /* Assigment of value for BDW_P5 in the MPDDRC_BDW_PORT_456 register */
...
#define MPDDRC_BDW_PORT_456_BDW_P6(value)     (MPDDRC_BDW_PORT_456_BDW_P6_Msk & (_UINT32_(value) << MPDDRC_BDW_PORT_456_BDW_P6_Pos)) /* Assigment of value for BDW_P6 in the MPDDRC_BDW_PORT_456 register */
...
#define MPDDRC_IER_SEC(value)                 (MPDDRC_IER_SEC_Msk & (_UINT32_(value) << MPDDRC_IER_SEC_Pos)) /* Assigment of value for SEC in the MPDDRC_IER register */
...
#define MPDDRC_IER_RD_ERR(value)              (MPDDRC_IER_RD_ERR_Msk & (_UINT32_(value) << MPDDRC_IER_RD_ERR_Pos)) /* Assigment of value for RD_ERR in the MPDDRC_IER register */
...
#define MPDDRC_IDR_SEC(value)                 (MPDDRC_IDR_SEC_Msk & (_UINT32_(value) << MPDDRC_IDR_SEC_Pos)) /* Assigment of value for SEC in the MPDDRC_IDR register */
...
#define MPDDRC_IDR_RD_ERR(value)              (MPDDRC_IDR_RD_ERR_Msk & (_UINT32_(value) << MPDDRC_IDR_RD_ERR_Pos)) /* Assigment of value for RD_ERR in the MPDDRC_IDR register */
...
#define MPDDRC_IMR_SEC(value)                 (MPDDRC_IMR_SEC_Msk & (_UINT32_(value) << MPDDRC_IMR_SEC_Pos)) /* Assigment of value for SEC in the MPDDRC_IMR register */
...
#define MPDDRC_IMR_RD_ERR(value)              (MPDDRC_IMR_RD_ERR_Msk & (_UINT32_(value) << MPDDRC_IMR_RD_ERR_Pos)) /* Assigment of value for RD_ERR in the MPDDRC_IMR register */
...
#define MPDDRC_ISR_SEC(value)                 (MPDDRC_ISR_SEC_Msk & (_UINT32_(value) << MPDDRC_ISR_SEC_Pos)) /* Assigment of value for SEC in the MPDDRC_ISR register */
...
#define MPDDRC_ISR_RD_ERR(value)              (MPDDRC_ISR_RD_ERR_Msk & (_UINT32_(value) << MPDDRC_ISR_RD_ERR_Pos)) /* Assigment of value for RD_ERR in the MPDDRC_ISR register */
...
#define MPDDRC_SAFETY_ADDRESS(value)          (MPDDRC_SAFETY_ADDRESS_Msk & (_UINT32_(value) << MPDDRC_SAFETY_ADDRESS_Pos)) /* Assigment of value for ADDRESS in the MPDDRC_SAFETY register */
...
#define MPDDRC_SAFETY_EN(value)               (MPDDRC_SAFETY_EN_Msk & (_UINT32_(value) << MPDDRC_SAFETY_EN_Pos)) /* Assigment of value for EN in the MPDDRC_SAFETY register */
...
#define MPDDRC_WPMR_WPITEN(value)             (MPDDRC_WPMR_WPITEN_Msk & (_UINT32_(value) << MPDDRC_WPMR_WPITEN_Pos)) /* Assigment of value for WPITEN in the MPDDRC_WPMR register */
...
#define MPDDRC_WPMR_FIRSTE(value)             (MPDDRC_WPMR_FIRSTE_Msk & (_UINT32_(value) << MPDDRC_WPMR_FIRSTE_Pos)) /* Assigment of value for FIRSTE in the MPDDRC_WPMR register */
...
#define MPDDRC_WPSR_CGD(value)                (MPDDRC_WPSR_CGD_Msk & (_UINT32_(value) << MPDDRC_WPSR_CGD_Pos)) /* Assigment of value for CGD in the MPDDRC_WPSR register */
...
#define MPDDRC_WPSR_SEQE(value)               (MPDDRC_WPSR_SEQE_Msk & (_UINT32_(value) << MPDDRC_WPSR_SEQE_Pos)) /* Assigment of value for SEQE in the MPDDRC_WPSR register */
...
#define MPDDRC_WPSR_SWE(value)                (MPDDRC_WPSR_SWE_Msk & (_UINT32_(value) << MPDDRC_WPSR_SWE_Pos)) /* Assigment of value for SWE in the MPDDRC_WPSR register */
...
#define MPDDRC_WPSR_SWETYP(value)             (MPDDRC_WPSR_SWETYP_Msk & (_UINT32_(value) << MPDDRC_WPSR_SWETYP_Pos)) /* Assigment of value for SWETYP in the MPDDRC_WPSR register */
...
#define MPDDRC_WPSR_ECLASS(value)             (MPDDRC_WPSR_ECLASS_Msk & (_UINT32_(value) << MPDDRC_WPSR_ECLASS_Pos)) /* Assigment of value for ECLASS in the MPDDRC_WPSR register */
