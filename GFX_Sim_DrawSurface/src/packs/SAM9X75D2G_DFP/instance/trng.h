...
#ifndef _SAM9X7_TRNG_INSTANCE_
#define _SAM9X7_TRNG_INSTANCE_


/* ========== Instance Parameter definitions for TRNG peripheral ========== */
#define TRNG_CLOCK_ID                            (38)       
#define TRNG_INSTANCE_ID                         (38)       /* True Random Number Generator */

#endif /* _SAM9X7_TRNG_INSTANCE_ */
