...
leResult screenShow_Game_Screen(void)
{
    ...
    Game_Screen_ButtonWidget_Logo->fn->setSize(Game_Screen_ButtonWidget_Logo, 155, 35);
    ...
    Game_Screen_ButtonWidget_Game_Rst->fn->setSize(Game_Screen_ButtonWidget_Game_Rst, 82, 33);
