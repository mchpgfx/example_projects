...
extern leLabelWidget* Screen0_lblScreenLock;
extern leLabelWidget* Screen0_lblCounter;
extern leLabelWidget* Screen0_lblTap;
extern leWidget* Screen0_pnlLock;
extern leLabelWidget* Screen0_lblLock;
extern leButtonWidget* Screen0_btnUnlock;
