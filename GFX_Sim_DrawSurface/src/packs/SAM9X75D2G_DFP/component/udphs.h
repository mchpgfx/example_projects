...
#define UDPHS_EPTRST_Msk                      _UINT32_(0x0000007F)                                 /* (UDPHS_EPTRST) Register Mask  */

#define UDPHS_EPTRST_EPT__Pos                 _UINT32_(0)                                          /* (UDPHS_EPTRST Position) Endpoint 6 Reset */
...
#endif /* _SAM9X7_UDPHS_COMPONENT_H_ */
