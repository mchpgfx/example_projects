...
#ifndef _SAM9X7_PUF_INSTANCE_
#define _SAM9X7_PUF_INSTANCE_


/* ========== Instance Parameter definitions for PUF peripheral ========== */
#define PUF_CLOCK_ID                             (59)       
#define PUF_INSTANCE_ID                          (59)       /* HW PUF QuiddiKey IP */

#endif /* _SAM9X7_PUF_INSTANCE_ */
