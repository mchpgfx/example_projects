...
${OBJECTDIR}/_ext/1360937237/app_Screen0.o: ../src/app_Screen0.c  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}/_ext/1360937237" 
	@${RM} ${OBJECTDIR}/_ext/1360937237/app_Screen0.o.d 
	@${RM} ${OBJECTDIR}/_ext/1360937237/app_Screen0.o 
	${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG   -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -ffunction-sections -fdata-sections -O1 -fno-common -I"../src" -I"../src/config/default" -I"../src/packs/ATSAME54P20A_DFP" -I"../src/packs/CMSIS/" -I"../src/packs/CMSIS/CMSIS/Core/Include" -Werror -Wall -MMD -MF "${OBJECTDIR}/_ext/1360937237/app_Screen0.o.d" -o ${OBJECTDIR}/_ext/1360937237/app_Screen0.o ../src/app_Screen0.c    -DXPRJ_default=$(CND_CONF)    $(COMPARISON_BUILD)  -mdfp="${DFP_DIR}" ${PACK_COMMON_OPTIONS} 
	@${FIXDEPS} "${OBJECTDIR}/_ext/1360937237/app_Screen0.o.d" $(SILENT) -rsi ${MP_CC_DIR}../ 
